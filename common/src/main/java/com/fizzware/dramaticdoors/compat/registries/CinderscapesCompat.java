...
public class CinderscapesCompat
{
	...
	private static void registerBlocksItems() {
		DDRegistry.registerDoorBlockAndItem(DDNames.TALL_SCORCHED, DDNames.SHORT_SCORCHED, DDRegistry.getBlockFromResourceLocation(new ResourceLocation("cinderscapes", "scorched_door")), true, DDRegistry.MAIN_TAB);
		DDRegistry.registerDoorBlockAndItem(DDNames.TALL_UMBRAL, DDNames.SHORT_UMBRAL, DDRegistry.getBlockFromResourceLocation(new ResourceLocation("cinderscapes", "umbral_door")), true, DDRegistry.MAIN_TAB);
	}
