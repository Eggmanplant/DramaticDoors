...
public class CauponaCompat
{
	...
	private static void registerBlocksItems() {
		DDRegistry.registerDoorBlockAndItem(DDNames.TALL_WALNUT, DDNames.SHORT_WALNUT, DDRegistry.getBlockFromResourceLocation(new ResourceLocation("caupona", "walnut_door")), true, DDRegistry.MAIN_TAB);
	}
