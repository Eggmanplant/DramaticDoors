...
public class ThermalFoundationCompat
{
	...
	private static void registerBlocksItems() {
		DDRegistry.registerDoorBlockAndItem(DDNames.TALL_RUBBERWOOD, DDNames.SHORT_RUBBERWOOD, DDRegistry.getBlockFromResourceLocation(new ResourceLocation("thermal", "rubberwood_door")), true, DDRegistry.MAIN_TAB);
	}
