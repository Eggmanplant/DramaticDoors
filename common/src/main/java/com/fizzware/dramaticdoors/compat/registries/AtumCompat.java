...
public class AtumCompat
{
	...
	private static void registerBlocksItems() {
		DDRegistry.registerDoorBlockAndItem(DDNames.TALL_DEADWOOD, DDNames.SHORT_DEADWOOD, DDRegistry.getBlockFromResourceLocation(new ResourceLocation("atum", "deadwood_door")), true, DDRegistry.MAIN_TAB);
		DDRegistry.registerDoorBlockAndItem(DDNames.TALL_PALM, DDNames.SHORT_PALM, DDRegistry.getBlockFromResourceLocation(new ResourceLocation("atum", "palm_door")), true, DDRegistry.MAIN_TAB);
		DDRegistry.registerDoorBlockAndItem(DDNames.TALL_LIMESTONE, DDNames.SHORT_LIMESTONE, DDRegistry.getBlockFromResourceLocation(new ResourceLocation("atum", "limestone_door")), true, DDRegistry.MAIN_TAB);
		DDRegistry.registerDoorBlockAndItem(DDNames.TALL_LIMESTONE_CRACKED, DDNames.SHORT_LIMESTONE_CRACKED, DDRegistry.getBlockFromResourceLocation(new ResourceLocation("atum", "limestone_cracked_door")), true, DDRegistry.MAIN_TAB);
		DDRegistry.registerDoorBlockAndItem(DDNames.TALL_LIMESTONE_BRICK_SMALL, DDNames.SHORT_LIMESTONE_BRICK_SMALL, DDRegistry.getBlockFromResourceLocation(new ResourceLocation("atum", "limestone_brick_small_door")), true, DDRegistry.MAIN_TAB);
		DDRegistry.registerDoorBlockAndItem(DDNames.TALL_LIMESTONE_BRICK_LARGE, DDNames.SHORT_LIMESTONE_BRICK_LARGE, DDRegistry.getBlockFromResourceLocation(new ResourceLocation("atum", "limestone_brick_large_door")), true, DDRegistry.MAIN_TAB);
		DDRegistry.registerDoorBlockAndItem(DDNames.TALL_LIMESTONE_BRICK_CRACKED_BRICK, DDNames.SHORT_LIMESTONE_BRICK_CRACKED_BRICK, DDRegistry.getBlockFromResourceLocation(new ResourceLocation("atum", "limestone_brick_cracked_brick_door")), true, DDRegistry.MAIN_TAB);
		DDRegistry.registerDoorBlockAndItem(DDNames.TALL_LIMESTONE_BRICK_CHISELED, DDNames.SHORT_LIMESTONE_BRICK_CHISELED, DDRegistry.getBlockFromResourceLocation(new ResourceLocation("atum", "limestone_brick_chiseled_door")), true, DDRegistry.MAIN_TAB);
		DDRegistry.registerDoorBlockAndItem(DDNames.TALL_LIMESTONE_BRICK_CARVED, DDNames.SHORT_LIMESTONE_BRICK_CARVED, DDRegistry.getBlockFromResourceLocation(new ResourceLocation("atum", "limestone_brick_carved_door")), true, DDRegistry.MAIN_TAB);
	}
