...
public class ArchitectsPaletteCompat
{
	...
	private static void registerBlocksItems() {
		DDRegistry.registerDoorBlockAndItem(DDNames.TALL_TWISTED, DDNames.SHORT_TWISTED, DDRegistry.getBlockFromResourceLocation(new ResourceLocation("architects_palette", "twisted_door")), true, DDRegistry.MAIN_TAB);
	}
