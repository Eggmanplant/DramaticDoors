...
public class RegionsUnexploredCompat
{
	...
	private static void registerBlocksItems() {
		...
		DDRegistry.registerDoorBlockAndItem(DDNames.TALL_RUE_CHERRY, DDNames.SHORT_RUE_CHERRY, DDRegistry.getBlockFromResourceLocation(new ResourceLocation("regions_unexplored", "cherry_door")), BlockSetType.CHERRY, true);
