...
{
    public static final Block SHORT_FLESH_DOOR = new ShortFleshDoorBlock(DDRegistry.getBlockFromResourceLocation(new ResourceLocation("biomancy", "flesh_door")));
    public static final Block SHORT_FULL_FLESH_DOOR = new ShortFullFleshDoorBlock(DDRegistry.getBlockFromResourceLocation(new ResourceLocation("biomancy", "full_flesh_door")));
    public static final Block SHORT_FLESHKIN_DOOR = new ShortDoorBlock(DDRegistry.getBlockFromResourceLocation(new ResourceLocation("biomancy", "fleshkin_door")));

    public static final Block TALL_FLESH_DOOR = new TallFleshDoorBlock(DDRegistry.getBlockFromResourceLocation(new ResourceLocation("biomancy", "flesh_door")));
    public static final Block TALL_FULL_FLESH_DOOR = new TallFullFleshDoorBlock(DDRegistry.getBlockFromResourceLocation(new ResourceLocation("biomancy", "full_flesh_door")));
    public static final Block TALL_FLESHKIN_DOOR = new TallDoorBlock(DDRegistry.getBlockFromResourceLocation(new ResourceLocation("biomancy", "fleshkin_door")));
	...
	private static void registerBlocksItems() {
    	...
    	DDRegistry.DOOR_ITEMS_TO_REGISTER.add(new Pair<String, Item>(DDNames.SHORT_FLESH, new ShortDoorItem(SHORT_FLESH_DOOR, DDRegistry.PROPERTIES.tab(DDRegistry.MAIN_TAB))));
    	DDRegistry.DOOR_ITEMS_TO_REGISTER.add(new Pair<String, Item>(DDNames.SHORT_FULL_FLESH, new ShortDoorItem(SHORT_FULL_FLESH_DOOR, DDRegistry.PROPERTIES.tab(DDRegistry.MAIN_TAB))));
    	DDRegistry.DOOR_ITEMS_TO_REGISTER.add(new Pair<String, Item>(DDNames.SHORT_FLESHKIN, new ShortDoorItem(SHORT_FLESHKIN_DOOR, DDRegistry.PROPERTIES.tab(DDRegistry.MAIN_TAB))));
    	DDRegistry.DOOR_ITEMS_TO_REGISTER.add(new Pair<String, Item>(DDNames.TALL_FLESH, new TallDoorItem(TALL_FLESH_DOOR, DDRegistry.PROPERTIES.tab(DDRegistry.MAIN_TAB))));
    	DDRegistry.DOOR_ITEMS_TO_REGISTER.add(new Pair<String, Item>(DDNames.TALL_FULL_FLESH, new TallDoorItem(TALL_FULL_FLESH_DOOR, DDRegistry.PROPERTIES.tab(DDRegistry.MAIN_TAB))));
    	DDRegistry.DOOR_ITEMS_TO_REGISTER.add(new Pair<String, Item>(DDNames.TALL_FLESHKIN, new TallDoorItem(TALL_FLESHKIN_DOOR, DDRegistry.PROPERTIES.tab(DDRegistry.MAIN_TAB))));
	}
