...
public class BlocksPlusCompat
{
	...
	private static void registerRecipes() {
		...
		DDCompatAdvancement.createRecipeAdvancement(DDNames.SHORT_BP_BAMBOO, new ResourceLocation("blocksplus", "bamboo_door"));
		...
		DDCompatAdvancement.createRecipeAdvancement(DDNames.TALL_BP_BAMBOO, new ResourceLocation("blocksplus", "bamboo_door"));
		...
		DDCompatRecipe.createShortDoorRecipe(DDNames.SHORT_BP_BAMBOO, new ResourceLocation("blocksplus", "bamboo_door"), true);
		...
		DDCompatRecipe.createTallDoorRecipe(DDNames.TALL_BP_BAMBOO, new ResourceLocation("blocksplus", "bamboo_door"), "tall_wooden_door");
	}
}
