...
public class FramedBlocksCompat
{
	...
	private static void registerBlocksItems() {
    	...
    	DDRegistry.DOOR_ITEMS_TO_REGISTER.add(new Pair<String, Item>(DDNames.TALL_FRAMED, new TallDoorItem(FramedBlocksCompat.TALL_FRAMED_DOOR, DDRegistry.PROPERTIES.tab(DDRegistry.MAIN_TAB))));
    	DDRegistry.DOOR_ITEMS_TO_REGISTER.add(new Pair<String, Item>(DDNames.TALL_FRAMED_IRON, new TallDoorItem(FramedBlocksCompat.TALL_FRAMED_IRON_DOOR, DDRegistry.PROPERTIES.tab(DDRegistry.MAIN_TAB))));
	}
