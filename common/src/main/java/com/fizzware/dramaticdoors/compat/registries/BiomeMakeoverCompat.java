...
public class BiomeMakeoverCompat
{
	...
	private static void registerBlocksItems() {
		DDRegistry.registerDoorBlockAndItem(DDNames.TALL_BM_ANCIENT_OAK, DDNames.SHORT_BM_ANCIENT_OAK, DDRegistry.getBlockFromResourceLocation(new ResourceLocation("biomemakeover", "ancient_oak_door")), true, DDRegistry.MAIN_TAB);
		DDRegistry.registerDoorBlockAndItem(DDNames.TALL_BM_BLIGHTED_BALSA, DDNames.SHORT_BM_BLIGHTED_BALSA, DDRegistry.getBlockFromResourceLocation(new ResourceLocation("biomemakeover", "blighted_balsa_door")), true, DDRegistry.MAIN_TAB);
		DDRegistry.registerDoorBlockAndItem(DDNames.TALL_BM_SWAMP_CYPRESS, DDNames.SHORT_BM_SWAMP_CYPRESS, DDRegistry.getBlockFromResourceLocation(new ResourceLocation("biomemakeover", "swamp_cypress_door")), true, DDRegistry.MAIN_TAB);
		DDRegistry.registerDoorBlockAndItem(DDNames.TALL_BM_WILLOW, DDNames.SHORT_BM_WILLOW, DDRegistry.getBlockFromResourceLocation(new ResourceLocation("biomemakeover", "willow_door")), true, DDRegistry.MAIN_TAB);
	}
