...
public class TerraqueousCompat
{
	...
	private static void registerBlocksItems() {
		DDRegistry.registerDoorBlockAndItem(DDNames.TALL_TQ_LIGHT_CLOUD, DDNames.SHORT_TQ_LIGHT_CLOUD, DDRegistry.getBlockFromResourceLocation(new ResourceLocation("terraqueous", "light_cloud_door")), true, DDRegistry.MAIN_TAB);
		DDRegistry.registerDoorBlockAndItem(DDNames.TALL_TQ_DENSE_CLOUD, DDNames.SHORT_TQ_DENSE_CLOUD, DDRegistry.getBlockFromResourceLocation(new ResourceLocation("terraqueous", "dense_cloud_door")), true, DDRegistry.MAIN_TAB);
		DDRegistry.registerDoorBlockAndItem(DDNames.TALL_TQ_STORM_CLOUD, DDNames.SHORT_TQ_STORM_CLOUD, DDRegistry.getBlockFromResourceLocation(new ResourceLocation("terraqueous", "storm_cloud_door")), true, DDRegistry.MAIN_TAB);
		DDRegistry.registerDoorBlockAndItem(DDNames.TALL_TQ_APPLE, DDNames.SHORT_TQ_APPLE, DDRegistry.getBlockFromResourceLocation(new ResourceLocation("terraqueous", "apple_door")), true, DDRegistry.MAIN_TAB);
		DDRegistry.registerDoorBlockAndItem(DDNames.TALL_TQ_BANANA, DDNames.SHORT_TQ_BANANA, DDRegistry.getBlockFromResourceLocation(new ResourceLocation("terraqueous", "banana_door")), true, DDRegistry.MAIN_TAB);
		DDRegistry.registerDoorBlockAndItem(DDNames.TALL_TQ_CHERRY, DDNames.SHORT_TQ_CHERRY, DDRegistry.getBlockFromResourceLocation(new ResourceLocation("terraqueous", "cherry_door")), true, DDRegistry.MAIN_TAB);
		DDRegistry.registerDoorBlockAndItem(DDNames.TALL_TQ_COCONUT, DDNames.SHORT_TQ_COCONUT, DDRegistry.getBlockFromResourceLocation(new ResourceLocation("terraqueous", "coconut_door")), true, DDRegistry.MAIN_TAB);
		DDRegistry.registerDoorBlockAndItem(DDNames.TALL_TQ_LEMON, DDNames.SHORT_TQ_LEMON, DDRegistry.getBlockFromResourceLocation(new ResourceLocation("terraqueous", "lemon_door")), true, DDRegistry.MAIN_TAB);
		DDRegistry.registerDoorBlockAndItem(DDNames.TALL_TQ_MANGO, DDNames.SHORT_TQ_MANGO, DDRegistry.getBlockFromResourceLocation(new ResourceLocation("terraqueous", "mango_door")), true, DDRegistry.MAIN_TAB);
		DDRegistry.registerDoorBlockAndItem(DDNames.TALL_TQ_MULBERRY, DDNames.SHORT_TQ_MULBERRY, DDRegistry.getBlockFromResourceLocation(new ResourceLocation("terraqueous", "mulberry_door")), true, DDRegistry.MAIN_TAB);
		DDRegistry.registerDoorBlockAndItem(DDNames.TALL_TQ_ORANGE, DDNames.SHORT_TQ_ORANGE, DDRegistry.getBlockFromResourceLocation(new ResourceLocation("terraqueous", "orange_door")), true, DDRegistry.MAIN_TAB);
		DDRegistry.registerDoorBlockAndItem(DDNames.TALL_TQ_PEACH, DDNames.SHORT_TQ_PEACH, DDRegistry.getBlockFromResourceLocation(new ResourceLocation("terraqueous", "peach_door")), true, DDRegistry.MAIN_TAB);
		DDRegistry.registerDoorBlockAndItem(DDNames.TALL_TQ_PEAR, DDNames.SHORT_TQ_PEAR, DDRegistry.getBlockFromResourceLocation(new ResourceLocation("terraqueous", "pear_door")), true, DDRegistry.MAIN_TAB);
		DDRegistry.registerDoorBlockAndItem(DDNames.TALL_TQ_PLUM, DDNames.SHORT_TQ_PLUM, DDRegistry.getBlockFromResourceLocation(new ResourceLocation("terraqueous", "plum_door")), true, DDRegistry.MAIN_TAB);
	}
