...
public class EnderscapeCompat
{
	...
	private static void registerBlocksItems() {
		DDRegistry.registerDoorBlockAndItem(DDNames.TALL_CELESTIAL, DDNames.SHORT_CELESTIAL, DDRegistry.getBlockFromResourceLocation(new ResourceLocation("enderscape", "celestial_door")), true, DDRegistry.MAIN_TAB);
		DDRegistry.registerDoorBlockAndItem(DDNames.TALL_MURUSHROOM, DDNames.SHORT_MURUSHROOM, DDRegistry.getBlockFromResourceLocation(new ResourceLocation("enderscape", "murushroom_door")), true, DDRegistry.MAIN_TAB);
	}
