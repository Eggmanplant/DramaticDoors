...
public class PromenadeCompat
{
	...
	private static void registerBlocksItems() {
		DDRegistry.registerDoorBlockAndItem(DDNames.TALL_PROMENADE_CHERRY_OAK, DDNames.SHORT_PROMENADE_CHERRY_OAK, DDRegistry.getBlockFromResourceLocation(new ResourceLocation("promenade", "cherry_oak_door")), true, DDRegistry.MAIN_TAB);
		DDRegistry.registerDoorBlockAndItem(DDNames.TALL_PROMENADE_DARK_AMARANTH, DDNames.SHORT_PROMENADE_DARK_AMARANTH, DDRegistry.getBlockFromResourceLocation(new ResourceLocation("promenade", "dark_amaranth_door")), true, DDRegistry.MAIN_TAB);
		DDRegistry.registerDoorBlockAndItem(DDNames.TALL_PROMENADE_PALM, DDNames.SHORT_PROMENADE_PALM, DDRegistry.getBlockFromResourceLocation(new ResourceLocation("promenade", "palm_door")), true, DDRegistry.MAIN_TAB);
	}
