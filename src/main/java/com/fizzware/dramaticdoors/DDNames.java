...
public class DDNames
{
    ...
    public static final String BIG_OAK = "big_oak_door";
    public static final String BIG_SPRUCE = "big_spruce_door";
    public static final String BIG_BIRCH = "big_birch_door";
    public static final String BIG_JUNGLE = "big_jungle_door";
    public static final String BIG_ACACIA = "big_acacia_door";
    public static final String BIG_DARK_OAK = "big_dark_oak_door";
    public static final String BIG_IRON = "big_iron_door";
    public static final String BIG_MANGROVE = "big_mangrove_door";
    public static final String BIG_CRIMSON = "big_crimson_door";
    public static final String BIG_WARPED = "big_warped_door";
    ...
    public static final String TALL_BYG_WHITE_MANGROVE = "tall_byg_mangrove_door";
    ...
    public static final String TALL_TOWERWOOD = "tall_towerwood_door"; //TF: Lost Blocks Addon
    ...
    public static final String TALL_COSMIC = "tall_cosmic_door";
    ...
    public static final String TALL_ROGGEN = "tall_roggen_door";
    public static final String TALL_RUMA = "tall_ruma_door";
    public static final String TALL_SAL = "tall_sal_door";
    public static final String TALL_SLIMED = "tall_slimed_door";
    public static final String TALL_TANTRA = "tall_tantra_door";
