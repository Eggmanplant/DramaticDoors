        ...
        switch (series) {
            ...
            /*case BYG:
            	return new Block[] {
            			...
            			Registry.BLOCK.get(new ResourceLocation("byg", "dead_door")),
            			Registry.BLOCK.get(new ResourceLocation("byg", "fir_door")),
            			Registry.BLOCK.get(new ResourceLocation("byg", "hellbark_door")),
            			Registry.BLOCK.get(new ResourceLocation("byg", "jacaranda_door")),
            			Registry.BLOCK.get(new ResourceLocation("byg", "magic_door")),
            			...
            			Registry.BLOCK.get(new ResourceLocation("byg", "umbran_door")),
