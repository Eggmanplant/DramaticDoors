...
public class DDTags
{
	...
	public static final TagKey<Block> MOB_OPENABLE_TALL_METAL_DOORS = TagKey.create(Registry.BLOCK_REGISTRY, new ResourceLocation(DramaticDoors.MOD_ID, "mob_openable_tall_metal_doors"));
