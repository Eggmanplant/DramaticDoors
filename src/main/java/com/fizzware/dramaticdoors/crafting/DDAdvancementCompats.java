...
public class DDAdvancementCompats
{
	...
	public static void initializeAdvancements() {
		...
		if (FabricLoader.getInstance().isModLoaded("glassdoor")) {
			createRecipeAdvancementJson(DDNames.SHORT_IRON_GLASS, new ResourceLocation("glassdoor", "iron_glassdoor"));
			createRecipeAdvancementJson(DDNames.SHORT_OAK_GLASS, new ResourceLocation("glassdoor", "oak_glassdoor"));
			createRecipeAdvancementJson(DDNames.SHORT_SPRUCE_GLASS, new ResourceLocation("glassdoor", "spruce_glassdoor"));
			createRecipeAdvancementJson(DDNames.SHORT_BIRCH_GLASS, new ResourceLocation("glassdoor", "birch_glassdoor"));
			createRecipeAdvancementJson(DDNames.SHORT_JUNGLE_GLASS, new ResourceLocation("glassdoor", "jungle_glassdoor"));
			createRecipeAdvancementJson(DDNames.SHORT_ACACIA_GLASS, new ResourceLocation("glassdoor", "acacia_glassdoor"));
			createRecipeAdvancementJson(DDNames.SHORT_DARK_OAK_GLASS, new ResourceLocation("glassdoor", "dark_oak_glassdoor"));
			createRecipeAdvancementJson(DDNames.SHORT_MANGROVE_GLASS, new ResourceLocation("glassdoor", "mangrove_glassdoor"));
			createRecipeAdvancementJson(DDNames.SHORT_CRIMSON_GLASS, new ResourceLocation("glassdoor", "crimson_glassdoor"));
			createRecipeAdvancementJson(DDNames.SHORT_WARPED_GLASS, new ResourceLocation("glassdoor", "warped_glassdoor"));
