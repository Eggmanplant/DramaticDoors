...
public class DDAdvancementCompats
{
	...
	public static void initializeAdvancements() {
		...
		if (FabricLoader.getInstance().isModLoaded("bewitchment")) {
			createRecipeAdvancementJson(DDNames.TALL_BW_CYPRESS, new Identifier("bewitchment", "cypress_door"));
		...
		if (FabricLoader.getInstance().isModLoaded("twigs")) {
			createRecipeAdvancementJson(DDNames.TALL_STRIPPED_BAMBOO, new Identifier("twigs", "stripped_bamboo_door"));	
		}
