...
public class DDRecipeCompats
{
	...
	public static void initializeRecipes() {
		...
		if (FabricLoader.getInstance().isModLoaded("glassdoor")) {
			...
			createTallDoorRecipeJson(DDNames.TALL_MANGROVE_GLASS, new Identifier("glassdoor", "mangrove_glassdoor"), "tall_glass_door");
		...
		if (FabricLoader.getInstance().isModLoaded("mcwdoors")) {
			...
			createTallDoorRecipeJson(DDNames.TALL_MACAW_MANGROVE_BARN, new Identifier("mcwdoors", "mangrove_barn_door"), "tall_macaw_barn_door");
			...
			createTallDoorRecipeJson(DDNames.TALL_MACAW_MANGROVE_BARN_GLASS, new Identifier("mcwdoors", "mangrove_barn_glass_door"), "tall_macaw_barn_glass_door");
			...
			createTallDoorRecipeJson(DDNames.TALL_MACAW_MANGROVE_STABLE, new Identifier("mcwdoors", "crimson_stable_door"), "tall_macaw_stable_door");
			...
			createTallDoorRecipeJson(DDNames.TALL_MACAW_MANGROVE_STABLE_HEAD, new Identifier("mcwdoors", "mangrove_stable_head_door"), "tall_macaw_stable_head_door");
			...
			createTallDoorRecipeJson(DDNames.TALL_MACAW_MANGROVE_BARK_GLASS, new Identifier("mcwdoors", "mangrove_bark_glass_door"), "tall_macaw_bark_glass_door");
			...
			createTallDoorRecipeJson(DDNames.TALL_MACAW_MANGROVE_GLASS, new Identifier("mcwdoors", "mangrove_glass_door"), "tall_macaw_glass_door");
			...
			createTallDoorRecipeJson(DDNames.TALL_MACAW_MANGROVE_MODERN, new Identifier("mcwdoors", "mangrove_modern_door"), "tall_macaw_modern_door");
			...
			createTallDoorRecipeJson(DDNames.TALL_MACAW_MANGROVE_JAPANESE, new Identifier("mcwdoors", "mangrove_japanese_door"), "tall_macaw_japanese_door");
			...
			createTallDoorRecipeJson(DDNames.TALL_MACAW_MANGROVE_JAPANESE2, new Identifier("mcwdoors", "mangrove_japanese2_door"), "tall_macaw_japanese2_door");
			...
			createTallDoorRecipeJson(DDNames.TALL_MACAW_MANGROVE_CLASSIC, new Identifier("mcwdoors", "mangrove_classic_door"), "tall_macaw_classic_door");
			...
			createTallDoorRecipeJson(DDNames.TALL_MACAW_MANGROVE_COTTAGE, new Identifier("mcwdoors", "mangrove_cottage_door"), "tall_macaw_cottage_door");
			...
			createTallDoorRecipeJson(DDNames.TALL_MACAW_MANGROVE_PAPER, new Identifier("mcwdoors", "mangrove_paper_door"), "tall_macaw_paper_door");
			...
			createTallDoorRecipeJson(DDNames.TALL_MACAW_MANGROVE_BEACH, new Identifier("mcwdoors", "mangrove_beach_door"), "tall_macaw_beach_door");
			...
			createTallDoorRecipeJson(DDNames.TALL_MACAW_MANGROVE_TROPICAL, new Identifier("mcwdoors", "mangrove_tropical_door"), "tall_macaw_tropical_door");
			...
			createTallDoorRecipeJson(DDNames.TALL_MACAW_MANGROVE_FOUR_PANEL, new Identifier("mcwdoors", "mangrove_four_panel_door"), "tall_macaw_four_panel_door");
			...
			createTallDoorRecipeJson(DDNames.TALL_MACAW_MANGROVE_NETHER, new Identifier("mcwdoors", "mangrove_nether_door"), "tall_macaw_nether_door");
			...
			createTallDoorRecipeJson(DDNames.TALL_MACAW_MANGROVE_MYSTIC, new Identifier("mcwdoors", "mangrove_mystic_door"), "tall_macaw_mystic_door");
