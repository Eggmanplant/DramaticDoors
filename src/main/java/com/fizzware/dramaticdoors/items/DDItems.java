...
public class DDItems {
    ...
    public static final Item TALL_MANGROVE_DOOR = new TallDoorItem(DDBlocks.TALL_MANGROVE_DOOR, new FabricItemSettings().group(conditionalTabProperties("wildbackport", DramaticDoors.DD_MAIN_TAB)));
