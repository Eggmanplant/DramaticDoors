...
public class DDItems {
    ...
    public static final Item TALL_MANGROVE_DOOR = new TallDoorItem(DDBlocks.TALL_MANGROVE_DOOR, new FabricItemSettings().group(conditionalTabProperties("wildbackport", DramaticDoors.DD_TAB))); // Only with Wild Backport or in 1.19+
