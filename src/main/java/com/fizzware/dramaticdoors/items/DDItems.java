...
public class DDItems {
    ...
    //public static final RegistryObject<Item> TALL_MANGROVE_DOOR = ITEMS.register(DDNames.NAME_MANGROVE, () -> new TallDoorItem(DDBlocks.TALL_MANGROVE_DOOR.get(), PROPERTIES.tab(DramaticDoors.TAB))); // Only in 1.19+
    ...
    public static final RegistryObject<Item> TALL_GLOWSHROOM_DOOR = ITEMS.register(DDNames.NAME_GLOWSHROOM, () -> new TallDoorItem(DDBlocks.TALL_GLOWSHROOM_DOOR.get(), addIfItemIsAvailable(new ResourceLocation("enhanced_mushrooms", "glowshroom_door"), conditionalTabProperties("enhanced_mushrooms"))));
