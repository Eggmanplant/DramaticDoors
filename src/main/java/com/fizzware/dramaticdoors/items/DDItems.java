...
public class DDItems {
	...
	// Vanilla
    public static final Item SHORT_IRON_DOOR = new ShortDoorItem(DDBlocks.SHORT_IRON_DOOR, new FabricItemSettings().group(DramaticDoors.DD_MAIN_TAB));
    public static final Item SHORT_OAK_DOOR = new ShortDoorItem(DDBlocks.SHORT_OAK_DOOR, new FabricItemSettings().group(DramaticDoors.DD_MAIN_TAB));
    public static final Item SHORT_SPRUCE_DOOR = new ShortDoorItem(DDBlocks.SHORT_SPRUCE_DOOR, new FabricItemSettings().group(DramaticDoors.DD_MAIN_TAB));
    public static final Item SHORT_BIRCH_DOOR = new ShortDoorItem(DDBlocks.SHORT_BIRCH_DOOR, new FabricItemSettings().group(DramaticDoors.DD_MAIN_TAB));
    public static final Item SHORT_JUNGLE_DOOR = new ShortDoorItem(DDBlocks.SHORT_JUNGLE_DOOR, new FabricItemSettings().group(DramaticDoors.DD_MAIN_TAB));
    public static final Item SHORT_ACACIA_DOOR = new ShortDoorItem(DDBlocks.SHORT_ACACIA_DOOR, new FabricItemSettings().group(DramaticDoors.DD_MAIN_TAB));
    public static final Item SHORT_DARK_OAK_DOOR = new ShortDoorItem(DDBlocks.SHORT_DARK_OAK_DOOR, new FabricItemSettings().group(DramaticDoors.DD_MAIN_TAB));
    public static final Item SHORT_MANGROVE_DOOR = new ShortDoorItem(DDBlocks.SHORT_MANGROVE_DOOR, new FabricItemSettings().group(DramaticDoors.DD_MAIN_TAB));
    public static final Item SHORT_BAMBOO_DOOR = new ShortDoorItem(DDBlocks.SHORT_BAMBOO_DOOR, new FabricItemSettings().group(conditionalTabProperties("one_twenty_backport", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_CRIMSON_DOOR = new ShortDoorItem(DDBlocks.SHORT_CRIMSON_DOOR, new FabricItemSettings().group(DramaticDoors.DD_MAIN_TAB));
    public static final Item SHORT_WARPED_DOOR = new ShortDoorItem(DDBlocks.SHORT_WARPED_DOOR, new FabricItemSettings().group(DramaticDoors.DD_MAIN_TAB));
    ...
    public static final Item TALL_MANGROVE_DOOR = new TallDoorItem(DDBlocks.TALL_MANGROVE_DOOR, new FabricItemSettings().group(DramaticDoors.DD_MAIN_TAB));
    public static final Item TALL_BAMBOO_DOOR = new TallDoorItem(DDBlocks.TALL_BAMBOO_DOOR, new FabricItemSettings().group(conditionalTabProperties("one_twenty_backport", DramaticDoors.DD_MAIN_TAB)));
    ...
    // Team Aurora
    public static final Item SHORT_JACARANDA_DOOR = new ShortDoorItem(DDBlocks.SHORT_JACARANDA_DOOR, new FabricItemSettings().group(conditionalTabProperties("abundance", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_REDBUD_DOOR = new ShortDoorItem(DDBlocks.SHORT_REDBUD_DOOR, new FabricItemSettings().group(conditionalTabProperties("abundance", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_CYPRESS_DOOR = new ShortDoorItem(DDBlocks.SHORT_CYPRESS_DOOR, new FabricItemSettings().group(conditionalTabProperties("bayou_blues", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_BROWN_MUSHROOM_DOOR = new ShortDoorItem(DDBlocks.SHORT_BROWN_MUSHROOM_DOOR, new FabricItemSettings().group(conditionalTabProperties("enhanced_mushrooms", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_RED_MUSHROOM_DOOR = new ShortDoorItem(DDBlocks.SHORT_RED_MUSHROOM_DOOR, new FabricItemSettings().group(conditionalTabProperties("enhanced_mushrooms", DramaticDoors.DD_MAIN_TAB)));
    ...
    // Ad Astra
    public static final Item SHORT_AERONOS_DOOR = new ShortDoorItem(DDBlocks.SHORT_AERONOS_DOOR, new FabricItemSettings().group(conditionalTabProperties("ad_astra", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_GLACIAN_DOOR = new ShortDoorItem(DDBlocks.SHORT_GLACIAN_DOOR, new FabricItemSettings().group(conditionalTabProperties("ad_astra", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_STROPHAR_DOOR = new ShortDoorItem(DDBlocks.SHORT_STROPHAR_DOOR, new FabricItemSettings().group(conditionalTabProperties("ad_astra", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_STEEL_DOOR = new ShortDoorItem(DDBlocks.SHORT_STEEL_DOOR, new FabricItemSettings().group(conditionalTabProperties("ad_astra", DramaticDoors.DD_MAIN_TAB)));    
    ...
    // Aether
    public static final Item SHORT_AETHER_SKYROOT_DOOR = new ShortDoorItem(DDBlocks.SHORT_AETHER_SKYROOT_DOOR, new FabricItemSettings().group(conditionalTabProperties("aether", DramaticDoors.DD_MAIN_TAB)));

    public static final Item TALL_AETHER_SKYROOT_DOOR = new TallDoorItem(DDBlocks.TALL_AETHER_SKYROOT_DOOR, new FabricItemSettings().group(conditionalTabProperties("aether", DramaticDoors.DD_MAIN_TAB)));
    
    // Architects Palette
    public static final Item SHORT_TWISTED_DOOR = new ShortDoorItem(DDBlocks.SHORT_TWISTED_DOOR, new FabricItemSettings().group(conditionalTabProperties("architects_palette", DramaticDoors.DD_MAIN_TAB)));
    ...
    // Bamboo Everything
    public static final Item SHORT_BE_BAMBOO_DOOR = new ShortDoorItem(DDBlocks.SHORT_BE_BAMBOO_DOOR, new FabricItemSettings().group(conditionalTabProperties("bambooeverything", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_BE_DRY_BAMBOO_DOOR = new ShortDoorItem(DDBlocks.SHORT_BE_DRY_BAMBOO_DOOR, new FabricItemSettings().group(conditionalTabProperties("bambooeverything", DramaticDoors.DD_MAIN_TAB)));

    public static final Item TALL_BE_BAMBOO_DOOR = new TallDoorItem(DDBlocks.TALL_BE_BAMBOO_DOOR, new FabricItemSettings().group(conditionalTabProperties("bambooeverything", DramaticDoors.DD_MAIN_TAB)));
    public static final Item TALL_BE_DRY_BAMBOO_DOOR = new TallDoorItem(DDBlocks.TALL_BE_DRY_BAMBOO_DOOR, new FabricItemSettings().group(conditionalTabProperties("bambooeverything", DramaticDoors.DD_MAIN_TAB)));
    
    // Better End
    public static final Item SHORT_TERMINITE_DOOR = new ShortDoorItem(DDBlocks.SHORT_TERMINITE_DOOR, new FabricItemSettings().group(conditionalTabProperties("betterend", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_THALLASIUM_DOOR = new ShortDoorItem(DDBlocks.SHORT_THALLASIUM_DOOR, new FabricItemSettings().group(conditionalTabProperties("betterend", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_DRAGON_TREE_DOOR = new ShortDoorItem(DDBlocks.SHORT_DRAGON_TREE_DOOR, new FabricItemSettings().group(conditionalTabProperties("betterend", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_END_LOTUS_DOOR = new ShortDoorItem(DDBlocks.SHORT_END_LOTUS_DOOR, new FabricItemSettings().group(conditionalTabProperties("betterend", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_HELIX_TREE_DOOR = new ShortDoorItem(DDBlocks.SHORT_HELIX_TREE_DOOR, new FabricItemSettings().group(conditionalTabProperties("betterend", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_JELLYSHROOM_DOOR = new ShortDoorItem(DDBlocks.SHORT_JELLYSHROOM_DOOR, new FabricItemSettings().group(conditionalTabProperties("betterend", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_LACUGROVE_DOOR = new ShortDoorItem(DDBlocks.SHORT_LACUGROVE_DOOR, new FabricItemSettings().group(conditionalTabProperties("betterend", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_LUCERNIA_DOOR = new ShortDoorItem(DDBlocks.SHORT_LUCERNIA_DOOR, new FabricItemSettings().group(conditionalTabProperties("betterend", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_MOSSY_GLOWSHROOM_DOOR = new ShortDoorItem(DDBlocks.SHORT_MOSSY_GLOWSHROOM_DOOR, new FabricItemSettings().group(conditionalTabProperties("betterend", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_PYTHADENDRON_DOOR = new ShortDoorItem(DDBlocks.SHORT_PYTHADENDRON_DOOR, new FabricItemSettings().group(conditionalTabProperties("betterend", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_TENANEA_DOOR = new ShortDoorItem(DDBlocks.SHORT_TENANEA_DOOR, new FabricItemSettings().group(conditionalTabProperties("betterend", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_UMBRELLA_TREE_DOOR = new ShortDoorItem(DDBlocks.SHORT_UMBRELLA_TREE_DOOR, new FabricItemSettings().group(conditionalTabProperties("betterend", DramaticDoors.DD_MAIN_TAB)));
    ...
    // Better Nether
    public static final Item SHORT_ANCHOR_TREE_DOOR = new ShortDoorItem(DDBlocks.SHORT_ANCHOR_TREE_DOOR, new FabricItemSettings().group(conditionalTabProperties("betternether", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_BONE_CIN_DOOR = new ShortDoorItem(DDBlocks.SHORT_BONE_CIN_DOOR, new FabricItemSettings().group(conditionalTabProperties("betternether", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_BONE_REED_DOOR = new ShortDoorItem(DDBlocks.SHORT_BONE_REED_DOOR, new FabricItemSettings().group(conditionalTabProperties("betternether", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_MUSHROOM_FIR_DOOR = new ShortDoorItem(DDBlocks.SHORT_MUSHROOM_FIR_DOOR, new FabricItemSettings().group(conditionalTabProperties("betternether", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_NETHER_MUSHROOM_DOOR = new ShortDoorItem(DDBlocks.SHORT_NETHER_MUSHROOM_DOOR, new FabricItemSettings().group(conditionalTabProperties("betternether", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_NETHER_REED_DOOR = new ShortDoorItem(DDBlocks.SHORT_NETHER_REED_DOOR, new FabricItemSettings().group(conditionalTabProperties("betternether", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_NETHER_SAKURA_DOOR = new ShortDoorItem(DDBlocks.SHORT_NETHER_SAKURA_DOOR, new FabricItemSettings().group(conditionalTabProperties("betternether", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_RUBEUS_DOOR = new ShortDoorItem(DDBlocks.SHORT_RUBEUS_DOOR, new FabricItemSettings().group(conditionalTabProperties("betternether", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_STALAGNATE_DOOR = new ShortDoorItem(DDBlocks.SHORT_STALAGNATE_DOOR, new FabricItemSettings().group(conditionalTabProperties("betternether", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_WART_DOOR = new ShortDoorItem(DDBlocks.SHORT_WART_DOOR, new FabricItemSettings().group(conditionalTabProperties("betternether", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_BN_WILLOW_DOOR = new ShortDoorItem(DDBlocks.SHORT_BN_WILLOW_DOOR, new FabricItemSettings().group(conditionalTabProperties("betternether", DramaticDoors.DD_MAIN_TAB)));
    ...
    // Bewitchment
    public static final Item SHORT_BW_CYPRESS_DOOR = new ShortDoorItem(DDBlocks.SHORT_BW_CYPRESS_DOOR, new FabricItemSettings().group(conditionalTabProperties("bewitchment", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_DRAGONS_BLOOD_DOOR = new ShortDoorItem(DDBlocks.SHORT_DRAGONS_BLOOD_DOOR, new FabricItemSettings().group(conditionalTabProperties("bewitchment", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_ELDER_DOOR = new ShortDoorItem(DDBlocks.SHORT_ELDER_DOOR, new FabricItemSettings().group(conditionalTabProperties("bewitchment", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_JUNIPER_DOOR = new ShortDoorItem(DDBlocks.SHORT_JUNIPER_DOOR, new FabricItemSettings().group(conditionalTabProperties("bewitchment", DramaticDoors.DD_MAIN_TAB)));
    ...
    // Bewitchment Plus
    public static final Item SHORT_YEW_DOOR = new ShortDoorItem(DDBlocks.SHORT_YEW_DOOR, new FabricItemSettings().group(conditionalTabProperties("bwplus", DramaticDoors.DD_MAIN_TAB)));
    ...
    // Biomancy
    public static final Item SHORT_FLESH_DOOR = new ShortDoorItem(DDBlocks.SHORT_FLESH_DOOR, new FabricItemSettings().group(conditionalTabProperties("biomancy", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_FULL_FLESH_DOOR = new ShortDoorItem(DDBlocks.SHORT_FULL_FLESH_DOOR, new FabricItemSettings().group(conditionalTabProperties("biomancy", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_FLESHKIN_DOOR = new ShortDoorItem(DDBlocks.SHORT_FLESHKIN_DOOR, new FabricItemSettings().group(conditionalTabProperties("biomancy", DramaticDoors.DD_MAIN_TAB)));
    ...
    public static final Item TALL_FLESHKIN_DOOR = new TallDoorItem(DDBlocks.TALL_FLESHKIN_DOOR, new FabricItemSettings().group(conditionalTabProperties("biomancy", DramaticDoors.DD_MAIN_TAB)));
    
    // Biome Makeover
    public static final Item SHORT_BM_ANCIENT_OAK_DOOR = new ShortDoorItem(DDBlocks.SHORT_BM_ANCIENT_OAK_DOOR, new FabricItemSettings().group(conditionalTabProperties("biomemakeover", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_BM_BLIGHTED_BALSA_DOOR = new ShortDoorItem(DDBlocks.SHORT_BM_BLIGHTED_BALSA_DOOR, new FabricItemSettings().group(conditionalTabProperties("biomemakeover", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_BM_SWAMP_CYPRESS_DOOR = new ShortDoorItem(DDBlocks.SHORT_BM_SWAMP_CYPRESS_DOOR, new FabricItemSettings().group(conditionalTabProperties("biomemakeover", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_BM_WILLOW_DOOR = new ShortDoorItem(DDBlocks.SHORT_BM_WILLOW_DOOR, new FabricItemSettings().group(conditionalTabProperties("biomemakeover", DramaticDoors.DD_MAIN_TAB)));

    public static final Item TALL_BM_ANCIENT_OAK_DOOR = new TallDoorItem(DDBlocks.TALL_BM_ANCIENT_OAK_DOOR, new FabricItemSettings().group(conditionalTabProperties("biomemakeover", DramaticDoors.DD_MAIN_TAB)));
    public static final Item TALL_BM_BLIGHTED_BALSA_DOOR = new TallDoorItem(DDBlocks.TALL_BM_BLIGHTED_BALSA_DOOR, new FabricItemSettings().group(conditionalTabProperties("biomemakeover", DramaticDoors.DD_MAIN_TAB)));
    public static final Item TALL_BM_SWAMP_CYPRESS_DOOR = new TallDoorItem(DDBlocks.TALL_BM_SWAMP_CYPRESS_DOOR, new FabricItemSettings().group(conditionalTabProperties("biomemakeover", DramaticDoors.DD_MAIN_TAB)));
    public static final Item TALL_BM_WILLOW_DOOR = new TallDoorItem(DDBlocks.TALL_BM_WILLOW_DOOR, new FabricItemSettings().group(conditionalTabProperties("biomemakeover", DramaticDoors.DD_MAIN_TAB)));

    // Blockus
    public static final Item SHORT_BLOCKUS_BAMBOO_DOOR = new ShortDoorItem(DDBlocks.SHORT_BLOCKUS_BAMBOO_DOOR, new FabricItemSettings().group(conditionalTabProperties("blockus", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_BLOCKUS_CHARRED_DOOR = new ShortDoorItem(DDBlocks.SHORT_BLOCKUS_CHARRED_DOOR, new FabricItemSettings().group(conditionalTabProperties("blockus", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_BLOCKUS_PAPER_DOOR = new ShortDoorItem(DDBlocks.SHORT_BLOCKUS_PAPER_DOOR, new FabricItemSettings().group(conditionalTabProperties("blockus", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_BLOCKUS_WHITE_OAK_DOOR = new ShortDoorItem(DDBlocks.SHORT_BLOCKUS_WHITE_OAK_DOOR, new FabricItemSettings().group(conditionalTabProperties("blockus", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_BLOCKUS_STONE_DOOR = new ShortDoorItem(DDBlocks.SHORT_BLOCKUS_STONE_DOOR, new FabricItemSettings().group(conditionalTabProperties("blockus", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_BLOCKUS_BLACKSTONE_DOOR = new ShortDoorItem(DDBlocks.SHORT_BLOCKUS_BLACKSTONE_DOOR, new FabricItemSettings().group(conditionalTabProperties("blockus", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_BLOCKUS_OBSIDIAN_REINFORCED_DOOR = new ShortDoorItem(DDBlocks.SHORT_BLOCKUS_OBSIDIAN_REINFORCED_DOOR, new FabricItemSettings().group(conditionalTabProperties("blockus", DramaticDoors.DD_MAIN_TAB)));
    ...
    // The Ceilands
    public static final Item SHORT_CEILTRUNK_DOOR = new ShortDoorItem(DDBlocks.SHORT_CEILTRUNK_DOOR, new FabricItemSettings().group(conditionalTabProperties("ceilands", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_LUZAWOOD_DOOR = new ShortDoorItem(DDBlocks.SHORT_LUZAWOOD_DOOR, new FabricItemSettings().group(conditionalTabProperties("ceilands", DramaticDoors.DD_MAIN_TAB)));
    ...
    // Charm
    public static final Item SHORT_CHARM_AZALEA_DOOR = new ShortDoorItem(DDBlocks.SHORT_CHARM_AZALEA_DOOR, new FabricItemSettings().group(conditionalTabProperties("charm", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_CHARM_EBONY_DOOR = new ShortDoorItem(DDBlocks.SHORT_CHARM_EBONY_DOOR, new FabricItemSettings().group(conditionalTabProperties("charm", DramaticDoors.DD_MAIN_TAB)));
    ...
    // Cinderscapes
    public static final Item SHORT_SCORCHED_DOOR = new ShortDoorItem(DDBlocks.SHORT_SCORCHED_DOOR, new FabricItemSettings().group(conditionalTabProperties("cinderscapes", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_UMBRAL_DOOR = new ShortDoorItem(DDBlocks.SHORT_UMBRAL_DOOR, new FabricItemSettings().group(conditionalTabProperties("cinderscapes", DramaticDoors.DD_MAIN_TAB)));    

    public static final Item TALL_SCORCHED_DOOR = new TallDoorItem(DDBlocks.TALL_SCORCHED_DOOR, new FabricItemSettings().group(conditionalTabProperties("cinderscapes", DramaticDoors.DD_MAIN_TAB)));
    public static final Item TALL_UMBRAL_DOOR = new TallDoorItem(DDBlocks.TALL_UMBRAL_DOOR, new FabricItemSettings().group(conditionalTabProperties("cinderscapes", DramaticDoors.DD_MAIN_TAB)));    
    
    // Cobblemon
    public static final Item SHORT_APRICORN_DOOR = new ShortDoorItem(DDBlocks.SHORT_APRICORN_DOOR, new FabricItemSettings().group(conditionalTabProperties("cobblemon", DramaticDoors.DD_MAIN_TAB)));

    public static final Item TALL_APRICORN_DOOR = new TallDoorItem(DDBlocks.TALL_APRICORN_DOOR, new FabricItemSettings().group(conditionalTabProperties("cobblemon", DramaticDoors.DD_MAIN_TAB)));
    
    // Colourful Azaleas
    public static final Item SHORT_AZULE_AZALEA_DOOR = new ShortDoorItem(DDBlocks.SHORT_AZULE_AZALEA_DOOR, new FabricItemSettings().group(conditionalTabProperties("colorfulazaleas", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_BRIGHT_AZALEA_DOOR = new ShortDoorItem(DDBlocks.SHORT_BRIGHT_AZALEA_DOOR, new FabricItemSettings().group(conditionalTabProperties("colorfulazaleas", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_FISS_AZALEA_DOOR = new ShortDoorItem(DDBlocks.SHORT_FISS_AZALEA_DOOR, new FabricItemSettings().group(conditionalTabProperties("colorfulazaleas", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_ROZE_AZALEA_DOOR = new ShortDoorItem(DDBlocks.SHORT_ROZE_AZALEA_DOOR, new FabricItemSettings().group(conditionalTabProperties("colorfulazaleas", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_TECAL_AZALEA_DOOR = new ShortDoorItem(DDBlocks.SHORT_TECAL_AZALEA_DOOR, new FabricItemSettings().group(conditionalTabProperties("colorfulazaleas", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_TITANIUM_AZALEA_DOOR = new ShortDoorItem(DDBlocks.SHORT_TITANIUM_AZALEA_DOOR, new FabricItemSettings().group(conditionalTabProperties("colorfulazaleas", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_WALNUT_AZALEA_DOOR = new ShortDoorItem(DDBlocks.SHORT_WALNUT_AZALEA_DOOR, new FabricItemSettings().group(conditionalTabProperties("colorfulazaleas", DramaticDoors.DD_MAIN_TAB)));

    public static final Item TALL_AZULE_AZALEA_DOOR = new TallDoorItem(DDBlocks.TALL_AZULE_AZALEA_DOOR, new FabricItemSettings().group(conditionalTabProperties("colorfulazaleas", DramaticDoors.DD_MAIN_TAB)));
    public static final Item TALL_BRIGHT_AZALEA_DOOR = new TallDoorItem(DDBlocks.TALL_BRIGHT_AZALEA_DOOR, new FabricItemSettings().group(conditionalTabProperties("colorfulazaleas", DramaticDoors.DD_MAIN_TAB)));
    public static final Item TALL_FISS_AZALEA_DOOR = new TallDoorItem(DDBlocks.TALL_FISS_AZALEA_DOOR, new FabricItemSettings().group(conditionalTabProperties("colorfulazaleas", DramaticDoors.DD_MAIN_TAB)));
    public static final Item TALL_ROZE_AZALEA_DOOR = new TallDoorItem(DDBlocks.TALL_ROZE_AZALEA_DOOR, new FabricItemSettings().group(conditionalTabProperties("colorfulazaleas", DramaticDoors.DD_MAIN_TAB)));
    public static final Item TALL_TECAL_AZALEA_DOOR = new TallDoorItem(DDBlocks.TALL_TECAL_AZALEA_DOOR, new FabricItemSettings().group(conditionalTabProperties("colorfulazaleas", DramaticDoors.DD_MAIN_TAB)));
    public static final Item TALL_TITANIUM_AZALEA_DOOR = new TallDoorItem(DDBlocks.TALL_TITANIUM_AZALEA_DOOR, new FabricItemSettings().group(conditionalTabProperties("colorfulazaleas", DramaticDoors.DD_MAIN_TAB)));
    public static final Item TALL_WALNUT_AZALEA_DOOR = new TallDoorItem(DDBlocks.TALL_WALNUT_AZALEA_DOOR, new FabricItemSettings().group(conditionalTabProperties("colorfulazaleas", DramaticDoors.DD_MAIN_TAB)));
    
    // Create: Deco
    public static final Item SHORT_ANDESITE_DOOR = new ShortDoorItem(DDBlocks.SHORT_ANDESITE_DOOR, new FabricItemSettings().group(conditionalTabProperties("createdeco", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_BRASS_DOOR = new ShortDoorItem(DDBlocks.SHORT_BRASS_DOOR, new FabricItemSettings().group(conditionalTabProperties("createdeco", DramaticDoors.DD_MAIN_TAB)));    
    public static final Item SHORT_COPPER_DOOR = new ShortDoorItem(DDBlocks.SHORT_COPPER_DOOR, new FabricItemSettings().group(conditionalTabProperties("createdeco", DramaticDoors.DD_MAIN_TAB)));    
    public static final Item SHORT_ZINC_DOOR = new ShortDoorItem(DDBlocks.SHORT_ZINC_DOOR, new FabricItemSettings().group(conditionalTabProperties("createdeco", DramaticDoors.DD_MAIN_TAB)));    
    public static final Item SHORT_LOCKED_ANDESITE_DOOR = new ShortDoorItem(DDBlocks.SHORT_LOCKED_ANDESITE_DOOR, new FabricItemSettings().group(conditionalTabProperties("createdeco", DramaticDoors.DD_MAIN_TAB)));    
    public static final Item SHORT_LOCKED_BRASS_DOOR = new ShortDoorItem(DDBlocks.SHORT_LOCKED_BRASS_DOOR, new FabricItemSettings().group(conditionalTabProperties("createdeco", DramaticDoors.DD_MAIN_TAB)));    
    public static final Item SHORT_LOCKED_COPPER_DOOR = new ShortDoorItem(DDBlocks.SHORT_LOCKED_COPPER_DOOR, new FabricItemSettings().group(conditionalTabProperties("createdeco", DramaticDoors.DD_MAIN_TAB)));    
    public static final Item SHORT_LOCKED_ZINC_DOOR = new ShortDoorItem(DDBlocks.SHORT_LOCKED_ZINC_DOOR, new FabricItemSettings().group(conditionalTabProperties("createdeco", DramaticDoors.DD_MAIN_TAB)));    
    ...
    // Deeper Darker
    public static final Item SHORT_ECHO_DOOR = new ShortDoorItem(DDBlocks.SHORT_ECHO_DOOR, new FabricItemSettings().group(conditionalTabProperties("deeperdarker", DramaticDoors.DD_MAIN_TAB)));

    public static final Item TALL_ECHO_DOOR = new TallDoorItem(DDBlocks.TALL_ECHO_DOOR, new FabricItemSettings().group(conditionalTabProperties("deeperdarker", DramaticDoors.DD_MAIN_TAB)));
    
    // Ecologics
    public static final Item SHORT_ECO_AZALEA_DOOR = new ShortDoorItem(DDBlocks.SHORT_ECO_AZALEA_DOOR, new FabricItemSettings().group(conditionalTabProperties("ecologics", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_ECO_FLOWERING_AZALEA_DOOR = new ShortDoorItem(DDBlocks.SHORT_ECO_FLOWERING_AZALEA_DOOR, new FabricItemSettings().group(conditionalTabProperties("ecologics", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_ECO_COCONUT_DOOR = new ShortDoorItem(DDBlocks.SHORT_ECO_COCONUT_DOOR, new FabricItemSettings().group(conditionalTabProperties("ecologics", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_ECO_WALNUT_DOOR = new ShortDoorItem(DDBlocks.SHORT_ECO_WALNUT_DOOR, new FabricItemSettings().group(conditionalTabProperties("ecologics", DramaticDoors.DD_MAIN_TAB)));
    ...
    // Glass Doors
    public static final Item SHORT_IRON_GLASS_DOOR = new ShortDoorItem(DDBlocks.SHORT_IRON_GLASS_DOOR, new FabricItemSettings().group(conditionalTabProperties("glassdoor", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_OAK_GLASS_DOOR = new ShortDoorItem(DDBlocks.SHORT_OAK_GLASS_DOOR, new FabricItemSettings().group(conditionalTabProperties("glassdoor", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_SPRUCE_GLASS_DOOR = new ShortDoorItem(DDBlocks.SHORT_SPRUCE_GLASS_DOOR, new FabricItemSettings().group(conditionalTabProperties("glassdoor", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_BIRCH_GLASS_DOOR = new ShortDoorItem(DDBlocks.SHORT_BIRCH_GLASS_DOOR, new FabricItemSettings().group(conditionalTabProperties("glassdoor", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_JUNGLE_GLASS_DOOR = new ShortDoorItem(DDBlocks.SHORT_JUNGLE_GLASS_DOOR, new FabricItemSettings().group(conditionalTabProperties("glassdoor", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_ACACIA_GLASS_DOOR = new ShortDoorItem(DDBlocks.SHORT_ACACIA_GLASS_DOOR, new FabricItemSettings().group(conditionalTabProperties("glassdoor", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_DARK_OAK_GLASS_DOOR = new ShortDoorItem(DDBlocks.SHORT_DARK_OAK_GLASS_DOOR, new FabricItemSettings().group(conditionalTabProperties("glassdoor", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_MANGROVE_GLASS_DOOR = new ShortDoorItem(DDBlocks.SHORT_MANGROVE_GLASS_DOOR, new FabricItemSettings().group(conditionalTabProperties("glassdoor", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_CRIMSON_GLASS_DOOR = new ShortDoorItem(DDBlocks.SHORT_CRIMSON_GLASS_DOOR, new FabricItemSettings().group(conditionalTabProperties("glassdoor", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_WARPED_GLASS_DOOR = new ShortDoorItem(DDBlocks.SHORT_WARPED_GLASS_DOOR, new FabricItemSettings().group(conditionalTabProperties("glassdoor", DramaticDoors.DD_MAIN_TAB)));
    ...
    public static final Item TALL_MANGROVE_GLASS_DOOR = new TallDoorItem(DDBlocks.TALL_MANGROVE_GLASS_DOOR, new FabricItemSettings().group(conditionalTabProperties("glassdoor", DramaticDoors.DD_MAIN_TAB)));
    ...
    // Gardens of the Dead
    public static final Item SHORT_SOULBLIGHT_DOOR = new ShortDoorItem(DDBlocks.SHORT_SOULBLIGHT_DOOR, new FabricItemSettings().group(conditionalTabProperties("gardens_of_the_dead", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_WHISTLECANE_DOOR = new ShortDoorItem(DDBlocks.SHORT_WHISTLECANE_DOOR, new FabricItemSettings().group(conditionalTabProperties("gardens_of_the_dead", DramaticDoors.DD_MAIN_TAB)));

    public static final Item TALL_SOULBLIGHT_DOOR = new TallDoorItem(DDBlocks.TALL_SOULBLIGHT_DOOR, new FabricItemSettings().group(conditionalTabProperties("gardens_of_the_dead", DramaticDoors.DD_MAIN_TAB)));
    public static final Item TALL_WHISTLECANE_DOOR = new TallDoorItem(DDBlocks.TALL_WHISTLECANE_DOOR, new FabricItemSettings().group(conditionalTabProperties("gardens_of_the_dead", DramaticDoors.DD_MAIN_TAB)));    
    
    // Good Ending
    public static final Item SHORT_GE_CYPRESS_DOOR = new ShortDoorItem(DDBlocks.SHORT_GE_CYPRESS_DOOR, new FabricItemSettings().group(conditionalTabProperties("goodending", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_GE_MUDDY_OAK_DOOR = new ShortDoorItem(DDBlocks.SHORT_GE_MUDDY_OAK_DOOR, new FabricItemSettings().group(conditionalTabProperties("goodending", DramaticDoors.DD_MAIN_TAB)));

    public static final Item TALL_GE_CYPRESS_DOOR = new TallDoorItem(DDBlocks.TALL_GE_CYPRESS_DOOR, new FabricItemSettings().group(conditionalTabProperties("goodending", DramaticDoors.DD_MAIN_TAB)));
    public static final Item TALL_GE_MUDDY_OAK_DOOR = new TallDoorItem(DDBlocks.TALL_GE_MUDDY_OAK_DOOR, new FabricItemSettings().group(conditionalTabProperties("goodending", DramaticDoors.DD_MAIN_TAB)));
    
    // Graveyard
    public static final Item SHORT_DARK_IRON_DOOR = new ShortDoorItem(DDBlocks.SHORT_DARK_IRON_DOOR, new FabricItemSettings().group(conditionalTabProperties("graveyard", DramaticDoors.DD_MAIN_TAB)));

    public static final Item TALL_DARK_IRON_DOOR = new TallDoorItem(DDBlocks.TALL_DARK_IRON_DOOR, new FabricItemSettings().group(conditionalTabProperties("graveyard", DramaticDoors.DD_MAIN_TAB)));
    
    // Hephaestus (Tinkers Construct)
    public static final Item SHORT_BLOODSHROOM_DOOR = new ShortDoorItem(DDBlocks.SHORT_BLOODSHROOM_DOOR, new FabricItemSettings().group(conditionalTabProperties("tconstruct", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_GREENHEART_DOOR = new ShortDoorItem(DDBlocks.SHORT_GREENHEART_DOOR, new FabricItemSettings().group(conditionalTabProperties("tconstruct", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_SKYROOT_DOOR = new ShortDoorItem(DDBlocks.SHORT_SKYROOT_DOOR, new FabricItemSettings().group(conditionalTabProperties("tconstruct", DramaticDoors.DD_MAIN_TAB)));    
    ...
    // Hexcasting
    public static final Item SHORT_EDIFIED_DOOR = new ShortDoorItem(DDBlocks.SHORT_EDIFIED_DOOR, new FabricItemSettings().group(conditionalTabProperties("hexcasting", DramaticDoors.DD_MAIN_TAB)));    

    public static final Item TALL_EDIFIED_DOOR = new TallDoorItem(DDBlocks.TALL_EDIFIED_DOOR, new FabricItemSettings().group(conditionalTabProperties("hexcasting", DramaticDoors.DD_MAIN_TAB)));    
    
    // Oh the Biomes You'll Go
    public static final Item SHORT_BYG_ASPEN_DOOR = new ShortDoorItem(DDBlocks.SHORT_BYG_ASPEN_DOOR, new FabricItemSettings().group(conditionalTabProperties("byg", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_BYG_BAOBAB_DOOR = new ShortDoorItem(DDBlocks.SHORT_BYG_BAOBAB_DOOR, new FabricItemSettings().group(conditionalTabProperties("byg", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_BYG_BLUE_ENCHANTED_DOOR = new ShortDoorItem(DDBlocks.SHORT_BYG_BLUE_ENCHANTED_DOOR, new FabricItemSettings().group(conditionalTabProperties("byg", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_BYG_BULBIS_DOOR = new ShortDoorItem(DDBlocks.SHORT_BYG_BULBIS_DOOR, new FabricItemSettings().group(conditionalTabProperties("byg", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_BYG_CHERRY_DOOR = new ShortDoorItem(DDBlocks.SHORT_BYG_CHERRY_DOOR, new FabricItemSettings().group(conditionalTabProperties("byg", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_BYG_CIKA_DOOR = new ShortDoorItem(DDBlocks.SHORT_BYG_CIKA_DOOR, new FabricItemSettings().group(conditionalTabProperties("byg", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_BYG_CYPRESS_DOOR = new ShortDoorItem(DDBlocks.SHORT_BYG_CYPRESS_DOOR, new FabricItemSettings().group(conditionalTabProperties("byg", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_BYG_EBONY_DOOR = new ShortDoorItem(DDBlocks.SHORT_BYG_EBONY_DOOR, new FabricItemSettings().group(conditionalTabProperties("byg", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_BYG_EMBUR_DOOR = new ShortDoorItem(DDBlocks.SHORT_BYG_EMBUR_DOOR, new FabricItemSettings().group(conditionalTabProperties("byg", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_BYG_ETHER_DOOR = new ShortDoorItem(DDBlocks.SHORT_BYG_ETHER_DOOR, new FabricItemSettings().group(conditionalTabProperties("byg", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_BYG_FIR_DOOR = new ShortDoorItem(DDBlocks.SHORT_BYG_FIR_DOOR, new FabricItemSettings().group(conditionalTabProperties("byg", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_BYG_FLORUS_DOOR = new ShortDoorItem(DDBlocks.SHORT_BYG_FLORUS_DOOR, new FabricItemSettings().group(/*conditionalTabProperties("byg", DramaticDoors.DD_MAIN_TAB)*/null));
    public static final Item SHORT_BYG_GREEN_ENCHANTED_DOOR = new ShortDoorItem(DDBlocks.SHORT_BYG_GREEN_ENCHANTED_DOOR, new FabricItemSettings().group(conditionalTabProperties("byg", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_BYG_HOLLY_DOOR = new ShortDoorItem(DDBlocks.SHORT_BYG_HOLLY_DOOR, new FabricItemSettings().group(conditionalTabProperties("byg", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_BYG_IMPARIUS_DOOR = new ShortDoorItem(DDBlocks.SHORT_BYG_IMPARIUS_DOOR, new FabricItemSettings().group(conditionalTabProperties("byg", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_BYG_IRONWOOD_DOOR = new ShortDoorItem(DDBlocks.SHORT_BYG_IRONWOOD_DOOR, new FabricItemSettings().group(/*conditionalTabProperties("byg", DramaticDoors.DD_MAIN_TAB)*/null));
    public static final Item SHORT_BYG_JACARANDA_DOOR = new ShortDoorItem(DDBlocks.SHORT_BYG_JACARANDA_DOOR, new FabricItemSettings().group(conditionalTabProperties("byg", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_BYG_LAMENT_DOOR = new ShortDoorItem(DDBlocks.SHORT_BYG_LAMENT_DOOR, new FabricItemSettings().group(conditionalTabProperties("byg", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_BYG_MAHOGANY_DOOR = new ShortDoorItem(DDBlocks.SHORT_BYG_MAHOGANY_DOOR, new FabricItemSettings().group(conditionalTabProperties("byg", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_BYG_MAPLE_DOOR = new ShortDoorItem(DDBlocks.SHORT_BYG_MAPLE_DOOR, new FabricItemSettings().group(conditionalTabProperties("byg", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_BYG_NIGHTSHADE_DOOR = new ShortDoorItem(DDBlocks.SHORT_BYG_NIGHTSHADE_DOOR, new FabricItemSettings().group(conditionalTabProperties("byg", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_BYG_PALM_DOOR = new ShortDoorItem(DDBlocks.SHORT_BYG_PALM_DOOR, new FabricItemSettings().group(conditionalTabProperties("byg", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_BYG_PINE_DOOR = new ShortDoorItem(DDBlocks.SHORT_BYG_PINE_DOOR, new FabricItemSettings().group(conditionalTabProperties("byg", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_BYG_RAINBOW_EUCALYPTUS_DOOR = new ShortDoorItem(DDBlocks.SHORT_BYG_RAINBOW_EUCALYPTUS_DOOR, new FabricItemSettings().group(conditionalTabProperties("byg", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_BYG_REDWOOD_DOOR = new ShortDoorItem(DDBlocks.SHORT_BYG_REDWOOD_DOOR, new FabricItemSettings().group(conditionalTabProperties("byg", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_BYG_SKYRIS_DOOR = new ShortDoorItem(DDBlocks.SHORT_BYG_SKYRIS_DOOR, new FabricItemSettings().group(conditionalTabProperties("byg", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_BYG_SOUL_SHROOM_DOOR = new ShortDoorItem(DDBlocks.SHORT_BYG_SOUL_SHROOM_DOOR, new FabricItemSettings().group(/*conditionalTabProperties("byg", DramaticDoors.DD_MAIN_TAB)*/null));
    public static final Item SHORT_BYG_SYTHIAN_DOOR = new ShortDoorItem(DDBlocks.SHORT_BYG_SYTHIAN_DOOR, new FabricItemSettings().group(conditionalTabProperties("byg", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_BYG_WHITE_MANGROVE_DOOR = new ShortDoorItem(DDBlocks.SHORT_BYG_WHITE_MANGROVE_DOOR, new FabricItemSettings().group(conditionalTabProperties("byg", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_BYG_WILLOW_DOOR = new ShortDoorItem(DDBlocks.SHORT_BYG_WILLOW_DOOR, new FabricItemSettings().group(conditionalTabProperties("byg", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_BYG_WITCH_HAZEL_DOOR = new ShortDoorItem(DDBlocks.SHORT_BYG_WITCH_HAZEL_DOOR, new FabricItemSettings().group(conditionalTabProperties("byg", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_BYG_ZELKOVA_DOOR = new ShortDoorItem(DDBlocks.SHORT_BYG_ZELKOVA_DOOR, new FabricItemSettings().group(conditionalTabProperties("byg", DramaticDoors.DD_MAIN_TAB)));
    ...
    // Promenade
    public static final Item SHORT_PROMENADE_CHERRY_OAK_DOOR = new ShortDoorItem(DDBlocks.SHORT_PROMENADE_CHERRY_OAK_DOOR, new FabricItemSettings().group(conditionalTabProperties("promenade", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_PROMENADE_DARK_AMARANTH_DOOR = new ShortDoorItem(DDBlocks.SHORT_PROMENADE_DARK_AMARANTH_DOOR, new FabricItemSettings().group(conditionalTabProperties("promenade", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_PROMENADE_PALM_DOOR = new ShortDoorItem(DDBlocks.SHORT_PROMENADE_PALM_DOOR, new FabricItemSettings().group(conditionalTabProperties("promenade", DramaticDoors.DD_MAIN_TAB)));    
    ...
    // Regions Unexplored
    public static final Item SHORT_RUE_BAOBAB_DOOR = new ShortDoorItem(DDBlocks.SHORT_RUE_BAOBAB_DOOR, new FabricItemSettings().group(conditionalTabProperties("regions_unexplored", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_RUE_BLACKWOOD_DOOR = new ShortDoorItem(DDBlocks.SHORT_RUE_BLACKWOOD_DOOR, new FabricItemSettings().group(conditionalTabProperties("regions_unexplored", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_RUE_BRIMWOOD_DOOR = new ShortDoorItem(DDBlocks.SHORT_RUE_BRIMWOOD_DOOR, new FabricItemSettings().group(conditionalTabProperties("regions_unexplored", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_RUE_CHERRY_DOOR = new ShortDoorItem(DDBlocks.SHORT_RUE_CHERRY_DOOR, new FabricItemSettings().group(conditionalTabProperties("regions_unexplored", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_RUE_CYPRESS_DOOR = new ShortDoorItem(DDBlocks.SHORT_RUE_CYPRESS_DOOR, new FabricItemSettings().group(conditionalTabProperties("regions_unexplored", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_RUE_DEAD_DOOR = new ShortDoorItem(DDBlocks.SHORT_RUE_DEAD_DOOR, new FabricItemSettings().group(conditionalTabProperties("regions_unexplored", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_RUE_EUCALYPTUS_DOOR = new ShortDoorItem(DDBlocks.SHORT_RUE_EUCALYPTUS_DOOR, new FabricItemSettings().group(conditionalTabProperties("regions_unexplored", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_RUE_JOSHUA_DOOR = new ShortDoorItem(DDBlocks.SHORT_RUE_JOSHUA_DOOR, new FabricItemSettings().group(conditionalTabProperties("regions_unexplored", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_RUE_LARCH_DOOR = new ShortDoorItem(DDBlocks.SHORT_RUE_LARCH_DOOR, new FabricItemSettings().group(conditionalTabProperties("regions_unexplored", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_RUE_MAPLE_DOOR = new ShortDoorItem(DDBlocks.SHORT_RUE_MAPLE_DOOR, new FabricItemSettings().group(conditionalTabProperties("regions_unexplored", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_RUE_MAUVE_DOOR = new ShortDoorItem(DDBlocks.SHORT_RUE_MAUVE_DOOR, new FabricItemSettings().group(conditionalTabProperties("regions_unexplored", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_RUE_PALM_DOOR = new ShortDoorItem(DDBlocks.SHORT_RUE_PALM_DOOR, new FabricItemSettings().group(conditionalTabProperties("regions_unexplored", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_RUE_PINE_DOOR = new ShortDoorItem(DDBlocks.SHORT_RUE_PINE_DOOR, new FabricItemSettings().group(conditionalTabProperties("regions_unexplored", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_RUE_REDWOOD_DOOR = new ShortDoorItem(DDBlocks.SHORT_RUE_REDWOOD_DOOR, new FabricItemSettings().group(conditionalTabProperties("regions_unexplored", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_RUE_WILLOW_DOOR = new ShortDoorItem(DDBlocks.SHORT_RUE_WILLOW_DOOR, new FabricItemSettings().group(conditionalTabProperties("regions_unexplored", DramaticDoors.DD_MAIN_TAB)));

    public static final Item TALL_RUE_BAOBAB_DOOR = new TallDoorItem(DDBlocks.TALL_RUE_BAOBAB_DOOR, new FabricItemSettings().group(conditionalTabProperties("regions_unexplored", DramaticDoors.DD_MAIN_TAB)));
    public static final Item TALL_RUE_BLACKWOOD_DOOR = new TallDoorItem(DDBlocks.TALL_RUE_BLACKWOOD_DOOR, new FabricItemSettings().group(conditionalTabProperties("regions_unexplored", DramaticDoors.DD_MAIN_TAB)));
    public static final Item TALL_RUE_BRIMWOOD_DOOR = new TallDoorItem(DDBlocks.TALL_RUE_BRIMWOOD_DOOR, new FabricItemSettings().group(conditionalTabProperties("regions_unexplored", DramaticDoors.DD_MAIN_TAB)));
    public static final Item TALL_RUE_CHERRY_DOOR = new TallDoorItem(DDBlocks.TALL_RUE_CHERRY_DOOR, new FabricItemSettings().group(conditionalTabProperties("regions_unexplored", DramaticDoors.DD_MAIN_TAB)));
    public static final Item TALL_RUE_CYPRESS_DOOR = new TallDoorItem(DDBlocks.TALL_RUE_CYPRESS_DOOR, new FabricItemSettings().group(conditionalTabProperties("regions_unexplored", DramaticDoors.DD_MAIN_TAB)));
    public static final Item TALL_RUE_DEAD_DOOR = new TallDoorItem(DDBlocks.TALL_RUE_DEAD_DOOR, new FabricItemSettings().group(conditionalTabProperties("regions_unexplored", DramaticDoors.DD_MAIN_TAB)));
    public static final Item TALL_RUE_EUCALYPTUS_DOOR = new TallDoorItem(DDBlocks.TALL_RUE_EUCALYPTUS_DOOR, new FabricItemSettings().group(conditionalTabProperties("regions_unexplored", DramaticDoors.DD_MAIN_TAB)));
    public static final Item TALL_RUE_JOSHUA_DOOR = new TallDoorItem(DDBlocks.TALL_RUE_JOSHUA_DOOR, new FabricItemSettings().group(conditionalTabProperties("regions_unexplored", DramaticDoors.DD_MAIN_TAB)));
    public static final Item TALL_RUE_LARCH_DOOR = new TallDoorItem(DDBlocks.TALL_RUE_LARCH_DOOR, new FabricItemSettings().group(conditionalTabProperties("regions_unexplored", DramaticDoors.DD_MAIN_TAB)));
    public static final Item TALL_RUE_MAPLE_DOOR = new TallDoorItem(DDBlocks.TALL_RUE_MAPLE_DOOR, new FabricItemSettings().group(conditionalTabProperties("regions_unexplored", DramaticDoors.DD_MAIN_TAB)));
    public static final Item TALL_RUE_MAUVE_DOOR = new TallDoorItem(DDBlocks.TALL_RUE_MAUVE_DOOR, new FabricItemSettings().group(conditionalTabProperties("regions_unexplored", DramaticDoors.DD_MAIN_TAB)));
    public static final Item TALL_RUE_PALM_DOOR = new TallDoorItem(DDBlocks.TALL_RUE_PALM_DOOR, new FabricItemSettings().group(conditionalTabProperties("regions_unexplored", DramaticDoors.DD_MAIN_TAB)));
    public static final Item TALL_RUE_PINE_DOOR = new TallDoorItem(DDBlocks.TALL_RUE_PINE_DOOR, new FabricItemSettings().group(conditionalTabProperties("regions_unexplored", DramaticDoors.DD_MAIN_TAB)));
    public static final Item TALL_RUE_REDWOOD_DOOR = new TallDoorItem(DDBlocks.TALL_RUE_REDWOOD_DOOR, new FabricItemSettings().group(conditionalTabProperties("regions_unexplored", DramaticDoors.DD_MAIN_TAB)));
    public static final Item TALL_RUE_WILLOW_DOOR = new TallDoorItem(DDBlocks.TALL_RUE_WILLOW_DOOR, new FabricItemSettings().group(conditionalTabProperties("regions_unexplored", DramaticDoors.DD_MAIN_TAB)));
    
    // Snowy Spirit
    public static final Item SHORT_GINGERBREAD_DOOR = new ShortDoorItem(DDBlocks.SHORT_GINGERBREAD_DOOR, new FabricItemSettings().group(conditionalTabProperties("snowyspirit", DramaticDoors.DD_MAIN_TAB)));
    ...
    // Supplementaries
    public static final Item SHORT_GOLD_DOOR = new ShortDoorItem(DDBlocks.SHORT_GOLD_DOOR, new FabricItemSettings().group(conditionalTabProperties("supplementaries", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_NETHERITE_DOOR = new ShortDoorItem(DDBlocks.SHORT_NETHERITE_DOOR, new FabricItemSettings().group(conditionalTabProperties("supplementaries", DramaticDoors.DD_MAIN_TAB)));
    ...
    // Tech Reborn
    public static final Item SHORT_RUBBER_DOOR = new ShortDoorItem(DDBlocks.SHORT_RUBBER_DOOR, new FabricItemSettings().group(conditionalTabProperties("techreborn", DramaticDoors.DD_MAIN_TAB)));
    ...
    // Terrestria
    public static final Item SHORT_TERRESTRIA_CYPRESS_DOOR = new ShortDoorItem(DDBlocks.SHORT_TERRESTRIA_CYPRESS_DOOR, new FabricItemSettings().group(conditionalTabProperties("terrestria", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_TERRESTRIA_HEMLOCK_DOOR = new ShortDoorItem(DDBlocks.SHORT_TERRESTRIA_HEMLOCK_DOOR, new FabricItemSettings().group(conditionalTabProperties("terrestria", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_TERRESTRIA_JAPANESE_MAPLE_DOOR = new ShortDoorItem(DDBlocks.SHORT_TERRESTRIA_JAPANESE_MAPLE_DOOR, new FabricItemSettings().group(conditionalTabProperties("terrestria", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_TERRESTRIA_RAINBOW_EUCALYPTUS_DOOR = new ShortDoorItem(DDBlocks.SHORT_TERRESTRIA_RAINBOW_EUCALYPTUS_DOOR, new FabricItemSettings().group(conditionalTabProperties("terrestria", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_TERRESTRIA_REDWOOD_DOOR = new ShortDoorItem(DDBlocks.SHORT_TERRESTRIA_REDWOOD_DOOR, new FabricItemSettings().group(conditionalTabProperties("terrestria", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_TERRESTRIA_RUBBER_DOOR = new ShortDoorItem(DDBlocks.SHORT_TERRESTRIA_RUBBER_DOOR, new FabricItemSettings().group(conditionalTabProperties("terrestria", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_TERRESTRIA_SAKURA_DOOR = new ShortDoorItem(DDBlocks.SHORT_TERRESTRIA_SAKURA_DOOR, new FabricItemSettings().group(conditionalTabProperties("terrestria", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_TERRESTRIA_WILLOW_DOOR = new ShortDoorItem(DDBlocks.SHORT_TERRESTRIA_WILLOW_DOOR, new FabricItemSettings().group(conditionalTabProperties("terrestria", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_TERRESTRIA_YUCCA_PALM_DOOR = new ShortDoorItem(DDBlocks.SHORT_TERRESTRIA_YUCCA_PALM_DOOR, new FabricItemSettings().group(conditionalTabProperties("terrestria", DramaticDoors.DD_MAIN_TAB)));

    public static final Item TALL_TERRESTRIA_CYPRESS_DOOR = new TallDoorItem(DDBlocks.TALL_TERRESTRIA_CYPRESS_DOOR, new FabricItemSettings().group(conditionalTabProperties("terrestria", DramaticDoors.DD_MAIN_TAB)));
    public static final Item TALL_TERRESTRIA_HEMLOCK_DOOR = new TallDoorItem(DDBlocks.TALL_TERRESTRIA_HEMLOCK_DOOR, new FabricItemSettings().group(conditionalTabProperties("terrestria", DramaticDoors.DD_MAIN_TAB)));
    public static final Item TALL_TERRESTRIA_JAPANESE_MAPLE_DOOR = new TallDoorItem(DDBlocks.TALL_TERRESTRIA_JAPANESE_MAPLE_DOOR, new FabricItemSettings().group(conditionalTabProperties("terrestria", DramaticDoors.DD_MAIN_TAB)));
    public static final Item TALL_TERRESTRIA_RAINBOW_EUCALYPTUS_DOOR = new TallDoorItem(DDBlocks.TALL_TERRESTRIA_RAINBOW_EUCALYPTUS_DOOR, new FabricItemSettings().group(conditionalTabProperties("terrestria", DramaticDoors.DD_MAIN_TAB)));
    public static final Item TALL_TERRESTRIA_REDWOOD_DOOR = new TallDoorItem(DDBlocks.TALL_TERRESTRIA_REDWOOD_DOOR, new FabricItemSettings().group(conditionalTabProperties("terrestria", DramaticDoors.DD_MAIN_TAB)));
    public static final Item TALL_TERRESTRIA_RUBBER_DOOR = new TallDoorItem(DDBlocks.TALL_TERRESTRIA_RUBBER_DOOR, new FabricItemSettings().group(conditionalTabProperties("terrestria", DramaticDoors.DD_MAIN_TAB)));
    public static final Item TALL_TERRESTRIA_SAKURA_DOOR = new TallDoorItem(DDBlocks.TALL_TERRESTRIA_SAKURA_DOOR, new FabricItemSettings().group(conditionalTabProperties("terrestria", DramaticDoors.DD_MAIN_TAB)));
    public static final Item TALL_TERRESTRIA_WILLOW_DOOR = new TallDoorItem(DDBlocks.TALL_TERRESTRIA_WILLOW_DOOR, new FabricItemSettings().group(conditionalTabProperties("terrestria", DramaticDoors.DD_MAIN_TAB)));
    public static final Item TALL_TERRESTRIA_YUCCA_PALM_DOOR = new TallDoorItem(DDBlocks.TALL_TERRESTRIA_YUCCA_PALM_DOOR, new FabricItemSettings().group(conditionalTabProperties("terrestria", DramaticDoors.DD_MAIN_TAB)));
    
    // Traverse
    public static final Item SHORT_TRAVERSE_FIR_DOOR = new ShortDoorItem(DDBlocks.SHORT_TRAVERSE_FIR_DOOR, new FabricItemSettings().group(conditionalTabProperties("traverse", DramaticDoors.DD_MAIN_TAB)));
    ...
    // Twigs
    public static final Item SHORT_STRIPPED_BAMBOO_DOOR = new ShortDoorItem(DDBlocks.SHORT_STRIPPED_BAMBOO_DOOR, new FabricItemSettings().group(conditionalTabProperties("twigs", DramaticDoors.DD_MAIN_TAB)));
    ...
    // Twilight Forest
    public static final Item SHORT_CANOPY_DOOR = new ShortDoorItem(DDBlocks.SHORT_CANOPY_DOOR, new FabricItemSettings().group(conditionalTabProperties("twilightforest", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_DARKWOOD_DOOR = new ShortDoorItem(DDBlocks.SHORT_DARKWOOD_DOOR, new FabricItemSettings().group(conditionalTabProperties("twilightforest", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_MINEWOOD_DOOR = new ShortDoorItem(DDBlocks.SHORT_MINEWOOD_DOOR, new FabricItemSettings().group(conditionalTabProperties("twilightforest", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_SORTINGWOOD_DOOR = new ShortDoorItem(DDBlocks.SHORT_SORTINGWOOD_DOOR, new FabricItemSettings().group(conditionalTabProperties("twilightforest", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_TIMEWOOD_DOOR = new ShortDoorItem(DDBlocks.SHORT_TIMEWOOD_DOOR, new FabricItemSettings().group(conditionalTabProperties("twilightforest", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_TRANSWOOD_DOOR = new ShortDoorItem(DDBlocks.SHORT_TRANSWOOD_DOOR, new FabricItemSettings().group(conditionalTabProperties("twilightforest", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_TWILIGHT_MANGROVE_DOOR = new ShortDoorItem(DDBlocks.SHORT_TWILIGHT_MANGROVE_DOOR, new FabricItemSettings().group(conditionalTabProperties("twilightforest", DramaticDoors.DD_MAIN_TAB)));
    public static final Item SHORT_TWILIGHT_OAK_DOOR = new ShortDoorItem(DDBlocks.SHORT_TWILIGHT_OAK_DOOR, new FabricItemSettings().group(conditionalTabProperties("twilightforest", DramaticDoors.DD_MAIN_TAB)));

    public static final Item SHORT_TOWERWOOD_DOOR = new ShortDoorItem(DDBlocks.SHORT_TOWERWOOD_DOOR, new FabricItemSettings().group(conditionalTabProperties("tflostblocks", DramaticDoors.DD_MAIN_TAB)));
    ...
    public static final Item TALL_TOWERWOOD_DOOR = new TallDoorItem(DDBlocks.TALL_TOWERWOOD_DOOR, new FabricItemSettings().group(conditionalTabProperties("tflostblocks", DramaticDoors.DD_MAIN_TAB)));

    // XP Obelisk
    public static final Item SHORT_SOUL_COPPER_DOOR = new ShortDoorItem(DDBlocks.SHORT_SOUL_COPPER_DOOR, new FabricItemSettings().group(conditionalTabProperties("xps_additions", DramaticDoors.DD_MAIN_TAB)));
    ...
    // Yippee
    public static final Item SHORT_MYSTICAL_OAK_DOOR = new ShortDoorItem(DDBlocks.SHORT_MYSTICAL_OAK_DOOR, new FabricItemSettings().group(conditionalTabProperties("yippee", DramaticDoors.DD_MAIN_TAB)));

    public static final Item TALL_MYSTICAL_OAK_DOOR = new TallDoorItem(DDBlocks.TALL_MYSTICAL_OAK_DOOR, new FabricItemSettings().group(conditionalTabProperties("yippee", DramaticDoors.DD_MAIN_TAB)));
    
    // Chipped (The biggest compat)
    public static final Item TALL_CHIPPED_OAK_HEAVY_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_OAK_HEAVY_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_OAK_DUAL_PANELED_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_OAK_DUAL_PANELED_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_OAK_PRESSED_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_OAK_PRESSED_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_OAK_SHACK_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_OAK_SHACK_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_OAK_FORTIFIED_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_OAK_FORTIFIED_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_OAK_SLIDING_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_OAK_SLIDING_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_OAK_SCREEN_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_OAK_SCREEN_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_OAK_GATED_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_OAK_GATED_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_OAK_GLASS_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_OAK_GLASS_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_OAK_WINDOWED_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_OAK_WINDOWED_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_OAK_TILED_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_OAK_TILED_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_OAK_TILE_WINDOWED_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_OAK_TILE_WINDOWED_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_OAK_SECRET_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_OAK_SECRET_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_OAK_BOARDED_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_OAK_BOARDED_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_OAK_PAPER_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_OAK_PAPER_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_OAK_BEACH_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_OAK_BEACH_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_OAK_BARRED_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_OAK_BARRED_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_OAK_PANELED_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_OAK_PANELED_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_OAK_SUPPORTED_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_OAK_SUPPORTED_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_OAK_OVERGROWN_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_OAK_OVERGROWN_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    
    public static final Item TALL_CHIPPED_SPRUCE_HEAVY_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_SPRUCE_HEAVY_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_SPRUCE_DUAL_PANELED_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_SPRUCE_DUAL_PANELED_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_SPRUCE_PRESSED_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_SPRUCE_PRESSED_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_SPRUCE_SHACK_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_SPRUCE_SHACK_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_SPRUCE_FORTIFIED_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_SPRUCE_FORTIFIED_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_SPRUCE_SLIDING_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_SPRUCE_SLIDING_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_SPRUCE_SCREEN_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_SPRUCE_SCREEN_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_SPRUCE_GATED_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_SPRUCE_GATED_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_SPRUCE_GLASS_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_SPRUCE_GLASS_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_SPRUCE_WINDOWED_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_SPRUCE_WINDOWED_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_SPRUCE_TILED_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_SPRUCE_TILED_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_SPRUCE_TILE_WINDOWED_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_SPRUCE_TILE_WINDOWED_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_SPRUCE_SECRET_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_SPRUCE_SECRET_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_SPRUCE_MODERN_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_SPRUCE_MODERN_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_SPRUCE_PAPER_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_SPRUCE_PAPER_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_SPRUCE_BEACH_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_SPRUCE_BEACH_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_SPRUCE_BARRED_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_SPRUCE_BARRED_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_SPRUCE_PANELED_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_SPRUCE_PANELED_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_SPRUCE_SUPPORTED_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_SPRUCE_SUPPORTED_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_SPRUCE_OVERGROWN_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_SPRUCE_OVERGROWN_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    
    public static final Item TALL_CHIPPED_BIRCH_HEAVY_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_BIRCH_HEAVY_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_BIRCH_DUAL_PANELED_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_BIRCH_DUAL_PANELED_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_BIRCH_PRESSED_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_BIRCH_PRESSED_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_BIRCH_SHACK_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_BIRCH_SHACK_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_BIRCH_FORTIFIED_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_BIRCH_FORTIFIED_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_BIRCH_SLIDING_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_BIRCH_SLIDING_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_BIRCH_SCREEN_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_BIRCH_SCREEN_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_BIRCH_GATED_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_BIRCH_GATED_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_BIRCH_GLASS_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_BIRCH_GLASS_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_BIRCH_WINDOWED_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_BIRCH_WINDOWED_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_BIRCH_TILED_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_BIRCH_TILED_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_BIRCH_TILE_WINDOWED_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_BIRCH_TILE_WINDOWED_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_BIRCH_SECRET_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_BIRCH_SECRET_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_BIRCH_MODERN_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_BIRCH_MODERN_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_BIRCH_BOARDED_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_BIRCH_BOARDED_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_BIRCH_BEACH_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_BIRCH_BEACH_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_BIRCH_BARRED_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_BIRCH_BARRED_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_BIRCH_PANELED_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_BIRCH_PANELED_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_BIRCH_SUPPORTED_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_BIRCH_SUPPORTED_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_BIRCH_OVERGROWN_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_BIRCH_OVERGROWN_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));

    public static final Item TALL_CHIPPED_JUNGLE_HEAVY_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_JUNGLE_HEAVY_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_JUNGLE_DUAL_PANELED_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_JUNGLE_DUAL_PANELED_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_JUNGLE_PRESSED_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_JUNGLE_PRESSED_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_JUNGLE_SHACK_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_JUNGLE_SHACK_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_JUNGLE_FORTIFIED_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_JUNGLE_FORTIFIED_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_JUNGLE_SLIDING_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_JUNGLE_SLIDING_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_JUNGLE_SCREEN_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_JUNGLE_SCREEN_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_JUNGLE_GATED_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_JUNGLE_GATED_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_JUNGLE_GLASS_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_JUNGLE_GLASS_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_JUNGLE_WINDOWED_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_JUNGLE_WINDOWED_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_JUNGLE_TILED_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_JUNGLE_TILED_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_JUNGLE_TILE_WINDOWED_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_JUNGLE_TILE_WINDOWED_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_JUNGLE_SECRET_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_JUNGLE_SECRET_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_JUNGLE_MODERN_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_JUNGLE_MODERN_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_JUNGLE_BOARDED_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_JUNGLE_BOARDED_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_JUNGLE_PAPER_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_JUNGLE_PAPER_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_JUNGLE_BARRED_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_JUNGLE_BARRED_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_JUNGLE_PANELED_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_JUNGLE_PANELED_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_JUNGLE_SUPPORTED_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_JUNGLE_SUPPORTED_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_JUNGLE_OVERGROWN_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_JUNGLE_OVERGROWN_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));

    public static final Item TALL_CHIPPED_ACACIA_HEAVY_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_ACACIA_HEAVY_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_ACACIA_DUAL_PANELED_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_ACACIA_DUAL_PANELED_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_ACACIA_PRESSED_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_ACACIA_PRESSED_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_ACACIA_SHACK_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_ACACIA_SHACK_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_ACACIA_FORTIFIED_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_ACACIA_FORTIFIED_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_ACACIA_SLIDING_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_ACACIA_SLIDING_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_ACACIA_SCREEN_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_ACACIA_SCREEN_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_ACACIA_GATED_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_ACACIA_GATED_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_ACACIA_GLASS_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_ACACIA_GLASS_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_ACACIA_WINDOWED_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_ACACIA_WINDOWED_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_ACACIA_TILED_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_ACACIA_TILED_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_ACACIA_TILE_WINDOWED_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_ACACIA_TILE_WINDOWED_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_ACACIA_SECRET_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_ACACIA_SECRET_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_ACACIA_MODERN_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_ACACIA_MODERN_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_ACACIA_BOARDED_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_ACACIA_BOARDED_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_ACACIA_PAPER_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_ACACIA_PAPER_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_ACACIA_BEACH_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_ACACIA_BEACH_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_ACACIA_PANELED_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_ACACIA_PANELED_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_ACACIA_SUPPORTED_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_ACACIA_SUPPORTED_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_ACACIA_OVERGROWN_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_ACACIA_OVERGROWN_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));

    public static final Item TALL_CHIPPED_DARK_OAK_HEAVY_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_DARK_OAK_HEAVY_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_DARK_OAK_DUAL_PANELED_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_DARK_OAK_DUAL_PANELED_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_DARK_OAK_PRESSED_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_DARK_OAK_PRESSED_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_DARK_OAK_SHACK_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_DARK_OAK_SHACK_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_DARK_OAK_FORTIFIED_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_DARK_OAK_FORTIFIED_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_DARK_OAK_SLIDING_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_DARK_OAK_SLIDING_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_DARK_OAK_SCREEN_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_DARK_OAK_SCREEN_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_DARK_OAK_GATED_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_DARK_OAK_GATED_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_DARK_OAK_GLASS_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_DARK_OAK_GLASS_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_DARK_OAK_WINDOWED_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_DARK_OAK_WINDOWED_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_DARK_OAK_TILED_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_DARK_OAK_TILED_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_DARK_OAK_TILE_WINDOWED_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_DARK_OAK_TILE_WINDOWED_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_DARK_OAK_SECRET_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_DARK_OAK_SECRET_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_DARK_OAK_MODERN_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_DARK_OAK_MODERN_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_DARK_OAK_BOARDED_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_DARK_OAK_BOARDED_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_DARK_OAK_PAPER_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_DARK_OAK_PAPER_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_DARK_OAK_BEACH_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_DARK_OAK_BEACH_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_DARK_OAK_BARRED_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_DARK_OAK_BARRED_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_DARK_OAK_SUPPORTED_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_DARK_OAK_SUPPORTED_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_DARK_OAK_OVERGROWN_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_DARK_OAK_OVERGROWN_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));

    public static final Item TALL_CHIPPED_MANGROVE_HEAVY_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_MANGROVE_HEAVY_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_MANGROVE_DUAL_PANELED_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_MANGROVE_DUAL_PANELED_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_MANGROVE_PRESSED_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_MANGROVE_PRESSED_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_MANGROVE_SHACK_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_MANGROVE_SHACK_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_MANGROVE_FORTIFIED_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_MANGROVE_FORTIFIED_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_MANGROVE_SLIDING_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_MANGROVE_SLIDING_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_MANGROVE_SCREEN_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_MANGROVE_SCREEN_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_MANGROVE_GATED_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_MANGROVE_GATED_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_MANGROVE_GLASS_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_MANGROVE_GLASS_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_MANGROVE_WINDOWED_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_MANGROVE_WINDOWED_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_MANGROVE_TILED_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_MANGROVE_TILED_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_MANGROVE_TILE_WINDOWED_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_MANGROVE_TILE_WINDOWED_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_MANGROVE_SECRET_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_MANGROVE_SECRET_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_MANGROVE_MODERN_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_MANGROVE_MODERN_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_MANGROVE_BOARDED_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_MANGROVE_BOARDED_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_MANGROVE_PAPER_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_MANGROVE_PAPER_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_MANGROVE_BEACH_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_MANGROVE_BEACH_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_MANGROVE_BARRED_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_MANGROVE_BARRED_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_MANGROVE_PANELED_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_MANGROVE_PANELED_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_MANGROVE_SUPPORTED_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_MANGROVE_SUPPORTED_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_MANGROVE_OVERGROWN_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_MANGROVE_OVERGROWN_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));

    public static final Item TALL_CHIPPED_CRIMSON_HEAVY_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_CRIMSON_HEAVY_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_CRIMSON_DUAL_PANELED_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_CRIMSON_DUAL_PANELED_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_CRIMSON_PRESSED_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_CRIMSON_PRESSED_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_CRIMSON_SHACK_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_CRIMSON_SHACK_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_CRIMSON_FORTIFIED_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_CRIMSON_FORTIFIED_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_CRIMSON_SLIDING_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_CRIMSON_SLIDING_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_CRIMSON_SCREEN_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_CRIMSON_SCREEN_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_CRIMSON_GATED_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_CRIMSON_GATED_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_CRIMSON_GLASS_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_CRIMSON_GLASS_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_CRIMSON_WINDOWED_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_CRIMSON_WINDOWED_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_CRIMSON_TILED_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_CRIMSON_TILED_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_CRIMSON_TILE_WINDOWED_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_CRIMSON_TILE_WINDOWED_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_CRIMSON_SECRET_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_CRIMSON_SECRET_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_CRIMSON_MODERN_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_CRIMSON_MODERN_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_CRIMSON_BOARDED_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_CRIMSON_BOARDED_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_CRIMSON_PAPER_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_CRIMSON_PAPER_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_CRIMSON_BEACH_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_CRIMSON_BEACH_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_CRIMSON_BARRED_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_CRIMSON_BARRED_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_CRIMSON_PANELED_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_CRIMSON_PANELED_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_CRIMSON_OVERGROWN_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_CRIMSON_OVERGROWN_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));

    public static final Item TALL_CHIPPED_WARPED_HEAVY_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_WARPED_HEAVY_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_WARPED_DUAL_PANELED_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_WARPED_DUAL_PANELED_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_WARPED_PRESSED_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_WARPED_PRESSED_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_WARPED_SHACK_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_WARPED_SHACK_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_WARPED_FORTIFIED_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_WARPED_FORTIFIED_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_WARPED_SLIDING_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_WARPED_SLIDING_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_WARPED_SCREEN_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_WARPED_SCREEN_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_WARPED_GATED_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_WARPED_GATED_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_WARPED_GLASS_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_WARPED_GLASS_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_WARPED_WINDOWED_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_WARPED_WINDOWED_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_WARPED_TILED_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_WARPED_TILED_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_WARPED_TILE_WINDOWED_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_WARPED_TILE_WINDOWED_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_WARPED_SECRET_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_WARPED_SECRET_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_WARPED_MODERN_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_WARPED_MODERN_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_WARPED_BOARDED_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_WARPED_BOARDED_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_WARPED_PAPER_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_WARPED_PAPER_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_WARPED_BEACH_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_WARPED_BEACH_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_WARPED_BARRED_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_WARPED_BARRED_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_WARPED_PANELED_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_WARPED_PANELED_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    public static final Item TALL_CHIPPED_WARPED_SUPPORTED_DOOR = new TallDoorItem(DDBlocks.TALL_CHIPPED_WARPED_SUPPORTED_DOOR, new FabricItemSettings().group(conditionalTabProperties("chipped", DramaticDoors.DD_CHIPPED_TAB)));
    
    // Macaw's Doors (The biggest compat)
    public static final Item TALL_MACAW_STORE_DOOR = new TallDoorItem(DDBlocks.TALL_MACAW_STORE_DOOR, new FabricItemSettings().group(conditionalTabProperties("mcwdoors", DramaticDoors.DD_MACAW_TAB)));
    public static final Item TALL_MACAW_SLIDING_GLASS_DOOR = new TallDoorItem(DDBlocks.TALL_MACAW_SLIDING_GLASS_DOOR, new FabricItemSettings().group(conditionalTabProperties("mcwdoors", DramaticDoors.DD_MACAW_TAB)));
	...
	public static final Item TALL_MACAW_MANGROVE_BARN_DOOR = new TallDoorItem(DDBlocks.TALL_MACAW_MANGROVE_BARN_DOOR, new FabricItemSettings().group(conditionalTabProperties("mcwdoors", DramaticDoors.DD_MACAW_TAB)));
	public static final Item TALL_MACAW_BAMBOO_BARN_DOOR = new TallDoorItem(DDBlocks.TALL_MACAW_BAMBOO_BARN_DOOR, new FabricItemSettings().group(conditionalTabProperties("mcwdoors", DramaticDoors.DD_MACAW_TAB)));
	...
	public static final Item TALL_MACAW_MANGROVE_BARN_GLASS_DOOR = new TallDoorItem(DDBlocks.TALL_MACAW_MANGROVE_BARN_GLASS_DOOR, new FabricItemSettings().group(conditionalTabProperties("mcwdoors", DramaticDoors.DD_MACAW_TAB)));
	public static final Item TALL_MACAW_BAMBOO_BARN_GLASS_DOOR = new TallDoorItem(DDBlocks.TALL_MACAW_BAMBOO_BARN_GLASS_DOOR, new FabricItemSettings().group(conditionalTabProperties("mcwdoors", DramaticDoors.DD_MACAW_TAB)));
	...
	public static final Item TALL_MACAW_MANGROVE_STABLE_DOOR = new TallDoorItem(DDBlocks.TALL_MACAW_MANGROVE_STABLE_DOOR, new FabricItemSettings().group(conditionalTabProperties("mcwdoors", DramaticDoors.DD_MACAW_TAB)));
	public static final Item TALL_MACAW_BAMBOO_STABLE_DOOR = new TallDoorItem(DDBlocks.TALL_MACAW_BAMBOO_STABLE_DOOR, new FabricItemSettings().group(conditionalTabProperties("mcwdoors", DramaticDoors.DD_MACAW_TAB)));
	...
	public static final Item TALL_MACAW_MANGROVE_STABLE_HEAD_DOOR = new TallDoorItem(DDBlocks.TALL_MACAW_MANGROVE_STABLE_HEAD_DOOR, new FabricItemSettings().group(conditionalTabProperties("mcwdoors", DramaticDoors.DD_MACAW_TAB)));
	public static final Item TALL_MACAW_BAMBOO_STABLE_HEAD_DOOR = new TallDoorItem(DDBlocks.TALL_MACAW_BAMBOO_STABLE_HEAD_DOOR, new FabricItemSettings().group(conditionalTabProperties("mcwdoors", DramaticDoors.DD_MACAW_TAB)));
	...
	public static final Item TALL_MACAW_MANGROVE_BARK_GLASS_DOOR = new TallDoorItem(DDBlocks.TALL_MACAW_MANGROVE_BARK_GLASS_DOOR, new FabricItemSettings().group(conditionalTabProperties("mcwdoors", DramaticDoors.DD_MACAW_TAB)));
	public static final Item TALL_MACAW_BAMBOO_BARK_GLASS_DOOR = new TallDoorItem(DDBlocks.TALL_MACAW_BAMBOO_BARK_GLASS_DOOR, new FabricItemSettings().group(conditionalTabProperties("mcwdoors", DramaticDoors.DD_MACAW_TAB)));
	...
	public static final Item TALL_MACAW_MANGROVE_GLASS_DOOR = new TallDoorItem(DDBlocks.TALL_MACAW_MANGROVE_GLASS_DOOR, new FabricItemSettings().group(conditionalTabProperties("mcwdoors", DramaticDoors.DD_MACAW_TAB)));
	public static final Item TALL_MACAW_BAMBOO_GLASS_DOOR = new TallDoorItem(DDBlocks.TALL_MACAW_BAMBOO_GLASS_DOOR, new FabricItemSettings().group(conditionalTabProperties("mcwdoors", DramaticDoors.DD_MACAW_TAB)));
	...
	public static final Item TALL_MACAW_MANGROVE_MODERN_DOOR = new TallDoorItem(DDBlocks.TALL_MACAW_MANGROVE_MODERN_DOOR, new FabricItemSettings().group(conditionalTabProperties("mcwdoors", DramaticDoors.DD_MACAW_TAB)));
	public static final Item TALL_MACAW_BAMBOO_MODERN_DOOR = new TallDoorItem(DDBlocks.TALL_MACAW_BAMBOO_MODERN_DOOR, new FabricItemSettings().group(conditionalTabProperties("mcwdoors", DramaticDoors.DD_MACAW_TAB)));
	...
	public static final Item TALL_MACAW_MANGROVE_JAPANESE_DOOR = new TallDoorItem(DDBlocks.TALL_MACAW_MANGROVE_JAPANESE_DOOR, new FabricItemSettings().group(conditionalTabProperties("mcwdoors", DramaticDoors.DD_MACAW_TAB)));
	public static final Item TALL_MACAW_BAMBOO_JAPANESE_DOOR = new TallDoorItem(DDBlocks.TALL_MACAW_BAMBOO_JAPANESE_DOOR, new FabricItemSettings().group(conditionalTabProperties("mcwdoors", DramaticDoors.DD_MACAW_TAB)));
	...
	public static final Item TALL_MACAW_MANGROVE_JAPANESE2_DOOR = new TallDoorItem(DDBlocks.TALL_MACAW_MANGROVE_JAPANESE2_DOOR, new FabricItemSettings().group(conditionalTabProperties("mcwdoors", DramaticDoors.DD_MACAW_TAB)));
	public static final Item TALL_MACAW_BAMBOO_JAPANESE2_DOOR = new TallDoorItem(DDBlocks.TALL_MACAW_BAMBOO_JAPANESE2_DOOR, new FabricItemSettings().group(conditionalTabProperties("mcwdoors", DramaticDoors.DD_MACAW_TAB)));
	...
	public static final Item TALL_MACAW_MANGROVE_CLASSIC_DOOR = new TallDoorItem(DDBlocks.TALL_MACAW_MANGROVE_CLASSIC_DOOR, new FabricItemSettings().group(conditionalTabProperties("mcwdoors", DramaticDoors.DD_MACAW_TAB)));
	public static final Item TALL_MACAW_BAMBOO_CLASSIC_DOOR = new TallDoorItem(DDBlocks.TALL_MACAW_BAMBOO_CLASSIC_DOOR, new FabricItemSettings().group(conditionalTabProperties("mcwdoors", DramaticDoors.DD_MACAW_TAB)));
	...
	public static final Item TALL_MACAW_MANGROVE_COTTAGE_DOOR = new TallDoorItem(DDBlocks.TALL_MACAW_MANGROVE_COTTAGE_DOOR, new FabricItemSettings().group(conditionalTabProperties("mcwdoors", DramaticDoors.DD_MACAW_TAB)));
	public static final Item TALL_MACAW_BAMBOO_COTTAGE_DOOR = new TallDoorItem(DDBlocks.TALL_MACAW_BAMBOO_COTTAGE_DOOR, new FabricItemSettings().group(conditionalTabProperties("mcwdoors", DramaticDoors.DD_MACAW_TAB)));
	...
	public static final Item TALL_MACAW_MANGROVE_PAPER_DOOR = new TallDoorItem(DDBlocks.TALL_MACAW_MANGROVE_PAPER_DOOR, new FabricItemSettings().group(conditionalTabProperties("mcwdoors", DramaticDoors.DD_MACAW_TAB)));
	public static final Item TALL_MACAW_BAMBOO_PAPER_DOOR = new TallDoorItem(DDBlocks.TALL_MACAW_BAMBOO_PAPER_DOOR, new FabricItemSettings().group(conditionalTabProperties("mcwdoors", DramaticDoors.DD_MACAW_TAB)));
	...
	public static final Item TALL_MACAW_MANGROVE_BEACH_DOOR = new TallDoorItem(DDBlocks.TALL_MACAW_MANGROVE_BEACH_DOOR, new FabricItemSettings().group(conditionalTabProperties("mcwdoors", DramaticDoors.DD_MACAW_TAB)));
	public static final Item TALL_MACAW_BAMBOO_BEACH_DOOR = new TallDoorItem(DDBlocks.TALL_MACAW_BAMBOO_BEACH_DOOR, new FabricItemSettings().group(conditionalTabProperties("mcwdoors", DramaticDoors.DD_MACAW_TAB)));
	...
	public static final Item TALL_MACAW_MANGROVE_TROPICAL_DOOR = new TallDoorItem(DDBlocks.TALL_MACAW_MANGROVE_TROPICAL_DOOR, new FabricItemSettings().group(conditionalTabProperties("mcwdoors", DramaticDoors.DD_MACAW_TAB)));
	public static final Item TALL_MACAW_BAMBOO_TROPICAL_DOOR = new TallDoorItem(DDBlocks.TALL_MACAW_BAMBOO_TROPICAL_DOOR, new FabricItemSettings().group(conditionalTabProperties("mcwdoors", DramaticDoors.DD_MACAW_TAB)));
	...
	public static final Item TALL_MACAW_MANGROVE_FOUR_PANEL_DOOR = new TallDoorItem(DDBlocks.TALL_MACAW_MANGROVE_FOUR_PANEL_DOOR, new FabricItemSettings().group(conditionalTabProperties("mcwdoors", DramaticDoors.DD_MACAW_TAB)));
	public static final Item TALL_MACAW_BAMBOO_FOUR_PANEL_DOOR = new TallDoorItem(DDBlocks.TALL_MACAW_BAMBOO_FOUR_PANEL_DOOR, new FabricItemSettings().group(conditionalTabProperties("mcwdoors", DramaticDoors.DD_MACAW_TAB)));
	...
	public static final Item TALL_MACAW_BAMBOO_SWAMP_DOOR = new TallDoorItem(DDBlocks.TALL_MACAW_BAMBOO_SWAMP_DOOR, new FabricItemSettings().group(conditionalTabProperties("mcwdoors", DramaticDoors.DD_MACAW_TAB)));
	...
	public static final Item TALL_MACAW_OAK_BAMBOO_DOOR = new TallDoorItem(DDBlocks.TALL_MACAW_OAK_BAMBOO_DOOR, new FabricItemSettings().group(conditionalTabProperties("mcwdoors", DramaticDoors.DD_MACAW_TAB)));
	public static final Item TALL_MACAW_SPRUCE_BAMBOO_DOOR = new TallDoorItem(DDBlocks.TALL_MACAW_SPRUCE_BAMBOO_DOOR, new FabricItemSettings().group(conditionalTabProperties("mcwdoors", DramaticDoors.DD_MACAW_TAB)));
	public static final Item TALL_MACAW_BIRCH_BAMBOO_DOOR = new TallDoorItem(DDBlocks.TALL_MACAW_BIRCH_BAMBOO_DOOR, new FabricItemSettings().group(conditionalTabProperties("mcwdoors", DramaticDoors.DD_MACAW_TAB)));
	public static final Item TALL_MACAW_JUNGLE_BAMBOO_DOOR = new TallDoorItem(DDBlocks.TALL_MACAW_JUNGLE_BAMBOO_DOOR, new FabricItemSettings().group(conditionalTabProperties("mcwdoors", DramaticDoors.DD_MACAW_TAB)));
	public static final Item TALL_MACAW_ACACIA_BAMBOO_DOOR = new TallDoorItem(DDBlocks.TALL_MACAW_ACACIA_BAMBOO_DOOR, new FabricItemSettings().group(conditionalTabProperties("mcwdoors", DramaticDoors.DD_MACAW_TAB)));
	public static final Item TALL_MACAW_DARK_OAK_BAMBOO_DOOR = new TallDoorItem(DDBlocks.TALL_MACAW_DARK_OAK_BAMBOO_DOOR, new FabricItemSettings().group(conditionalTabProperties("mcwdoors", DramaticDoors.DD_MACAW_TAB)));
	public static final Item TALL_MACAW_MANGROVE_BAMBOO_DOOR = new TallDoorItem(DDBlocks.TALL_MACAW_MANGROVE_BAMBOO_DOOR, new FabricItemSettings().group(conditionalTabProperties("mcwdoors", DramaticDoors.DD_MACAW_TAB)));
	public static final Item TALL_MACAW_CRIMSON_BAMBOO_DOOR = new TallDoorItem(DDBlocks.TALL_MACAW_CRIMSON_BAMBOO_DOOR, new FabricItemSettings().group(conditionalTabProperties("mcwdoors", DramaticDoors.DD_MACAW_TAB)));
	public static final Item TALL_MACAW_WARPED_BAMBOO_DOOR = new TallDoorItem(DDBlocks.TALL_MACAW_WARPED_BAMBOO_DOOR, new FabricItemSettings().group(conditionalTabProperties("mcwdoors", DramaticDoors.DD_MACAW_TAB)));
	...
	public static final Item TALL_MACAW_MANGROVE_NETHER_DOOR = new TallDoorItem(DDBlocks.TALL_MACAW_MANGROVE_NETHER_DOOR, new FabricItemSettings().group(conditionalTabProperties("mcwdoors", DramaticDoors.DD_MACAW_TAB)));
	public static final Item TALL_MACAW_BAMBOO_NETHER_DOOR = new TallDoorItem(DDBlocks.TALL_MACAW_BAMBOO_NETHER_DOOR, new FabricItemSettings().group(conditionalTabProperties("mcwdoors", DramaticDoors.DD_MACAW_TAB)));
	...
	public static final Item TALL_MACAW_MANGROVE_MYSTIC_DOOR = new TallDoorItem(DDBlocks.TALL_MACAW_MANGROVE_MYSTIC_DOOR, new FabricItemSettings().group(conditionalTabProperties("mcwdoors", DramaticDoors.DD_MACAW_TAB)));
	public static final Item TALL_MACAW_BAMBOO_MYSTIC_DOOR = new TallDoorItem(DDBlocks.TALL_MACAW_BAMBOO_MYSTIC_DOOR, new FabricItemSettings().group(conditionalTabProperties("mcwdoors", DramaticDoors.DD_MACAW_TAB)));
