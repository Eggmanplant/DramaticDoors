...
public class AtumCompat
{
	...
	private static void registerBlocksItems() {
		DDCompatRegistry.registerDoorBlockAndItem(DDNames.TALL_DEADWOOD, DDNames.SHORT_DEADWOOD, DDBlocks.getBlockFromResourceLocation(new ResourceLocation("atum", "deadwood_door")), BlockSetType.OAK, true);
		DDCompatRegistry.registerDoorBlockAndItem(DDNames.TALL_PALM, DDNames.SHORT_PALM, DDBlocks.getBlockFromResourceLocation(new ResourceLocation("atum", "palm_door")), BlockSetType.JUNGLE, true);
		DDCompatRegistry.registerDoorBlockAndItem(DDNames.TALL_LIMESTONE, DDNames.SHORT_LIMESTONE, DDBlocks.getBlockFromResourceLocation(new ResourceLocation("atum", "limestone_door")), BlockSetType.STONE, true);
		DDCompatRegistry.registerDoorBlockAndItem(DDNames.TALL_LIMESTONE_CRACKED, DDNames.SHORT_LIMESTONE_CRACKED, DDBlocks.getBlockFromResourceLocation(new ResourceLocation("atum", "limestone_cracked_door")), BlockSetType.STONE, true);
		DDCompatRegistry.registerDoorBlockAndItem(DDNames.TALL_LIMESTONE_BRICK_SMALL, DDNames.SHORT_LIMESTONE_BRICK_SMALL, DDBlocks.getBlockFromResourceLocation(new ResourceLocation("atum", "limestone_brick_small_door")), BlockSetType.STONE, true);
		DDCompatRegistry.registerDoorBlockAndItem(DDNames.TALL_LIMESTONE_BRICK_LARGE, DDNames.SHORT_LIMESTONE_BRICK_LARGE, DDBlocks.getBlockFromResourceLocation(new ResourceLocation("atum", "limestone_brick_large_door")), BlockSetType.STONE, true);
		DDCompatRegistry.registerDoorBlockAndItem(DDNames.TALL_LIMESTONE_BRICK_CRACKED_BRICK, DDNames.SHORT_LIMESTONE_BRICK_CRACKED_BRICK, DDBlocks.getBlockFromResourceLocation(new ResourceLocation("atum", "limestone_brick_cracked_brick_door")), BlockSetType.STONE, true);
		DDCompatRegistry.registerDoorBlockAndItem(DDNames.TALL_LIMESTONE_BRICK_CHISELED, DDNames.SHORT_LIMESTONE_BRICK_CHISELED, DDBlocks.getBlockFromResourceLocation(new ResourceLocation("atum", "limestone_brick_chiseled_door")), BlockSetType.STONE, true);
		DDCompatRegistry.registerDoorBlockAndItem(DDNames.TALL_LIMESTONE_BRICK_CARVED, DDNames.SHORT_LIMESTONE_BRICK_CARVED, DDBlocks.getBlockFromResourceLocation(new ResourceLocation("atum", "limestone_brick_carved_door")), BlockSetType.STONE, true);
	}
