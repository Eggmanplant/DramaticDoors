...
public class HexcastingCompat
{
	...
	private static void registerBlocksItems() {
		DDCompatRegistry.registerDoorBlockAndItem(DDNames.TALL_EDIFIED, DDNames.SHORT_EDIFIED, DDBlocks.getBlockFromResourceLocation(new ResourceLocation("hexcasting", "edified_door")), BlockSetType.OAK, true);
	}
